## [2024-10-25] Создание пользовательского интерфейса для модуля Webhook с использованием Angular
...
Общие библиотека содержит функции и классы которые используются другими `Angular`-библиотеками.
