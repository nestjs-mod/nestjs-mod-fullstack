...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async appControllerDemoCreateOne(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppDemo>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.appControllerDemoCreateOne(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.appControllerDemoCreateOne']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async appControllerDemoDeleteOne(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppDemo>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.appControllerDemoDeleteOne(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.appControllerDemoDeleteOne']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async appControllerDemoFindMany(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AppDemo>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.appControllerDemoFindMany(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.appControllerDemoFindMany']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async appControllerDemoFindOne(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppDemo>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.appControllerDemoFindOne(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.appControllerDemoFindOne']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async appControllerGetData(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AppData>> {
        ...
        async terminusHealthCheckControllerCheck(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TerminusHealthCheckControllerCheck200Response>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.terminusHealthCheckControllerCheck']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class DefaultApi extends BaseAPI {
    ...
    public appControllerDemoCreateOne(options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).appControllerDemoCreateOne(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public appControllerDemoDeleteOne(id: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).appControllerDemoDeleteOne(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public appControllerDemoFindMany(options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).appControllerDemoFindMany(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public appControllerDemoFindOne(id: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).appControllerDemoFindOne(id, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public terminusHealthCheckControllerCheck(options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).terminusHealthCheckControllerCheck(options).then((request) => request(this.axios, this.basePath));
    }
}
