...
const config: runtime.GetPrismaClientConfig = {
  generator: {
    ...
    output: {
      value: '/home/endy/Projects/nestjs-mod/nestjs-mod-fullstack/apps/server-sso/src/app/generated/prisma-client',
      fromEnvVar: null,
    },
    config: {
      moduleFormat: 'cjs',
    ...
    sourceFilePath: '/home/endy/Projects/nestjs-mod/nestjs-mod-fullstack/apps/server-sso/src/prisma/app-schema.prisma',
    isCustomOutput: true,
  },
  relativePath: '../../../prisma',
  clientVersion: '6.9.0',
...
> {
  ...
  /**
   * `prisma.appDemo`: Exposes CRUD operations for the **AppDemo** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more AppDemos
   * const appDemos = await prisma.appDemo.findMany()
   * ```
   */
  get appDemo(): Prisma.AppDemoDelegate<ExtArgs, ClientOptions>;

  /**
   * `prisma.migrations_server`: Exposes CRUD operations for the **migrations_server** model.
   * Example usage:
   * ```ts
   * // Fetch zero or more Migrations_servers
