    ...
    6935: () => {
      ...
      function xe(e, r) {
        for (let c = e.length - 1; c >= 0; c--)
          'function' == typeof e[c] && (e[c] = je(e[c], r + '_' + c));
        return e;
      }
      function We(e) {
        return (
          ...
          return (
            Ve && c === Te && 'error' === e.type
              ...
              : ((i = t && t.apply(this, arguments)),
                'beforeunload' === e.type && $[yt] && 'string' == typeof i
                  ? (e.returnValue = i)
      ...
      function $e(e, r, c) {
        let t = ke(e, r);
        if (
          (!t && c && ke(c, r) && (t = { enumerable: !0, configurable: !0 }),
          !t || !t.configurable)
        )
          return;
        ...
        const u = t.get,
          ...
          T = r.slice(2);
        let m = Ce[T];
        m || (m = Ce[T] = j('ON_PROPERTY' + T)),
          (t.set = function (D) {
            let d = this;
            !d && e === $ && (d = $),
              d &&
                ('function' == typeof d[m] && d.removeEventListener(T, Ye),
                E && E.call(d, null),
                (d[m] = D),
          ...
          const q = H
            ...
            a = function (s, l, v, C, y = !1, L = !1) {
              return function () {
                ...
                const Be = !!ie && ('boolean' == typeof ie || ie.capture),
                ...
                Pe && (Pe.taskData = O), me && (O.options.signal = void 0);
                ...
                return (
                  ...
                  Pe && (Pe.taskData = null),
                  lt && (O.options.once = !0),
                  (!ge && 'boolean' == typeof se.options) || (se.options = ie),
                  (se.target = I),
                  (se.capture = Be),
                  (se.eventName = M),
                  B && (se.originalDelegate = F),
                  L ? pe.unshift(se) : pe.push(se),
                  y ? I : void 0
                );
              };
            };
                  ...
                  if (Z.hasOwnProperty(d)) {
                    ...
                    x && x.value
                      ? ((x.value = e.wrapWithCurrentZone(x.value, w)),
                        e._redefineProperty(m.prototype, d, x))
        ...
        return (
          (e.Zone ??= (function ze() {
            ...
            let t = (() => {
              class N {
                ...
                wrap(n, o) {
                  ...
                  const p = this._zoneDelegate.intercept(this, n, o),
                    P = this;
                  return function () {
            ...
            const i = {
              ...
              onInvokeTask: (N, _, n, o, p, P) => N.invokeTask(n, o, p, P),
          ...
          e.__load_patch('ZoneAwarePromise', (r, c, t) => {
            ...
            class A {
              ...
              static race(a) {
                ...
                for (let L of a) J(L) || (L = this.resolve(L)), L.then(C, y);
                return v;
              }
              static all(a) {
              ...
              static allWithCallback(a, s) {
                ...
                for (let M of a) {
                  ...
                  try {
                    M.then(
                      (B) => {
                        (I[F] = s ? s.thenCallback(B) : B),
                          y--,
                          0 === y && l(I);
                      },
                      (B) => {
                        s
                          ? ((I[F] = s.errorCallback(B)), y--, 0 === y && l(I))
                          : v(B);
                      }
                    );
                  } catch (B) {
          ...
          (function Mt(e) {
            e.__load_patch('util', (r, c, t) => {
              ...
              r[E] && (r[u] = r[E]),
                ...
                (t.isIEOrEdge = kt),
                (t.ObjectDefineProperty = Ne),
                (t.ObjectGetOwnPropertyDescriptor = ke),
                (t.ObjectCreate = _t),
                (t.ArraySlice = Et),
                (t.patchClass = be),
                (t.wrapWithCurrentZone = je),
        ...
        (function Ot(e) {
          e.__load_patch('legacy', (r) => {
            ...
            e.__load_patch('on_property', (r, c, t) => {
              !(function St(e, r) {
                if ((Re && !Xe) || Zone[e.symbol('patchEvents')]) return;
                      ...
                      function (R, b) {
                        if (!0 === c.current[g] || R[i]) return z.apply(R, b);
                        {
                          const S = {
                            ...
                            Q = He('XMLHttpRequest.send', h, S, k, H);
                          R &&
                            !0 === R[m] &&
                            !S.aborted &&
                            Q.state === X &&
            ...
            e.__load_patch('PromiseRejectionEvent', (r, c) => {
              function t(i) {
                return function (u) {
                  st(r, i).forEach((T) => {
                    const m = r.PromiseRejectionEvent;
                    if (m) {
                      const D = new m(i, {
                        promise: u.promise,
                        reason: u.rejection,
