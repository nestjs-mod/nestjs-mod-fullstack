...
"use strict";
module.exports = require("@keyv/postgres");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AUTH_FOLDER = exports.AUTH_MODULE = exports.AUTH_FEATURE = void 0;
exports.AUTH_FEATURE = 'auth';
exports.AUTH_MODULE = 'AuthModule';
exports.AUTH_FOLDER = 'libs/core/auth';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CurrentAuthUser = exports.CurrentAuthRequest = exports.CheckAuthRole = exports.SkipAuthGuard = void 0;
...
const common_3 = __webpack_require__(9);
const common_4 = __webpack_require__(7);
const auth_guard_1 = __webpack_require__(27);
const auth_timezone_interceptor_1 = __webpack_require__(35);
exports.SkipAuthGuard = core_1.Reflector.createDecorator();
exports.CheckAuthRole = core_1.Reflector.createDecorator();
exports.CurrentAuthRequest = (0, common_2.createParamDecorator)((_data, ctx) => {
...
function UseAuthInterceptorsAndGuards(options) {
    return (0, common_4.applyDecorators)((0, common_2.UseInterceptors)(auth_timezone_interceptor_1.AuthTimezoneInterceptor), (0, common_2.UseGuards)(common_3.SupabaseGuard, auth_guard_1.AuthGuard), AddHandleConnection(), ...(options?.allowEmptyUser ? [(0, common_3.AllowEmptyUser)()] : []));
}
...
"use strict";
module.exports = require("@nestjs-mod/common");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SERVER_TIMEZONE_OFFSET = void 0;
exports.SERVER_TIMEZONE_OFFSET = new Date().getTimezoneOffset() / 60;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SUPABASE_MODULE = exports.SUPABASE_FEATURE = void 0;
exports.SUPABASE_FEATURE = 'supabase';
exports.SUPABASE_MODULE = 'SupabaseModule';
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CurrentSupabaseUserToken = exports.CurrentSupabaseUser = exports.CheckAccess = exports.AllowEmptyUser = exports.getSupabaseEnvironmentsLoaderToken = exports.getSupabaseServiceToken = exports.InjectSupabaseService = void 0;
const common_1 = __webpack_require__(6);
const core_1 = __webpack_require__(8);
const common_2 = __webpack_require__(7);
const supabase_constants_1 = __webpack_require__(12);
...
_a = (0, common_1.getNestModuleInternalUtils)({
    moduleName: supabase_constants_1.SUPABASE_MODULE,
}), exports.getSupabaseServiceToken = _a.getServiceToken, exports.getSupabaseEnvironmentsLoaderToken = _a.getEnvironmentsLoaderToken;
exports.AllowEmptyUser = core_1.Reflector.createDecorator();
exports.CheckAccess = core_1.Reflector.createDecorator();
exports.CurrentSupabaseUser = (0, common_2.createParamDecorator)((data, ctx) => {
    const request = (0, common_1.getRequestFromExecutionContext)(ctx);
    return request.supabaseUser;
});
exports.CurrentSupabaseUserToken = (0, common_2.createParamDecorator)((data, ctx) => {
    const request = (0, common_1.getRequestFromExecutionContext)(ctx);
...
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(6);
const class_validator_multi_lang_1 = __webpack_require__(15);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], SupabaseEnvironments.prototype, "supabaseURL", void 0);
tslib_1.__decorate([
    (0, common_1.EnvModelProperty)({
    ...
    (0, class_validator_multi_lang_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", String)
], SupabaseEnvironments.prototype, "supabaseKey", void 0);
tslib_1.__decorate([
    (0, common_1.EnvModelProperty)({
...
], SupabaseEnvironments.prototype, "allowedExternalAppIds", void 0);
...
"use strict";
module.exports = require("class-validator-multi-lang");
...
const supabase_service_1 = __webpack_require__(18);
...
const supabase_configuration_1 = __webpack_require__(11);
const supabase_decorators_1 = __webpack_require__(13);
const supabase_environments_1 = __webpack_require__(14);
const supabase_errors_1 = __webpack_require__(16);
let SupabaseService = SupabaseService_1 = class SupabaseService {
    ...
    onModuleInit() {
        this.supabaseClient = new supabase_js_1.SupabaseClient(this.supabaseEnvironments.supabaseURL, this.supabaseEnvironments.supabaseKey);
    }
    getSupabaseClient() {
    ...
    async getUserFromRequest(ctx, checkAccess = true) {
        ...
        const allowEmptyUserMetadata = (typeof ctx.getHandler === 'function' &&
            this.reflector.get(supabase_decorators_1.AllowEmptyUser, ctx.getHandler())) ||
            (typeof ctx.getClass === 'function' &&
                this.reflector.get(supabase_decorators_1.AllowEmptyUser, ctx.getClass())) ||
            undefined;
        const checkAccessMetadata = (typeof ctx.getHandler === 'function' &&
            this.reflector.get(supabase_decorators_1.CheckAccess, ctx.getHandler())) ||
            (typeof ctx.getClass === 'function' &&
                this.reflector.get(supabase_decorators_1.CheckAccess, ctx.getClass())) ||
            undefined;
        if (!req.supabaseUser?.id) {
            ...
            if (!req.supabaseUser) {
                ...
                if (req.externalAppId &&
                    !this.supabaseEnvironments.allowedExternalAppIds?.includes(req.externalAppId)) {
                    req.supabaseUser = {
...
exports.SupabaseService = SupabaseService = SupabaseService_1 = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof core_1.Reflector !== "undefined" && core_1.Reflector) === "function" ? _a : Object, typeof (_b = typeof supabase_configuration_1.SupabaseConfiguration !== "undefined" && supabase_configuration_1.SupabaseConfiguration) === "function" ? _b : Object, typeof (_c = typeof supabase_environments_1.SupabaseEnvironments !== "undefined" && supabase_environments_1.SupabaseEnvironments) === "function" ? _c : Object])
], SupabaseService);
...
const supabase_constants_1 = __webpack_require__(12);
const supabase_environments_1 = __webpack_require__(14);
const supabase_guard_1 = __webpack_require__(17);
const supabase_service_1 = __webpack_require__(18);
const supabase_configuration_1 = __webpack_require__(11);
...
const class_transformer_global_storage_1 = __webpack_require__(24);
const class_validator_multi_lang_1 = __webpack_require__(15);
class FindManyArgs {
}
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsNumber)(),
    (0, class_validator_multi_lang_1.IsOptional)(),
    (0, class_transformer_global_storage_1.Type)(() => Number),
    tslib_1.__metadata("design:type", Number)
], FindManyArgs.prototype, "curPage", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: Number }),
    (0, class_validator_multi_lang_1.IsNumber)(),
    (0, class_validator_multi_lang_1.IsOptional)(),
    (0, class_transformer_global_storage_1.Type)(() => Number),
    tslib_1.__metadata("design:type", Number)
], FindManyArgs.prototype, "perPage", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: String }),
    tslib_1.__metadata("design:type", String)
], FindManyArgs.prototype, "searchText", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: String }),
    tslib_1.__metadata("design:type", String)
], FindManyArgs.prototype, "sort", void 0);
...
"use strict";
module.exports = require("class-transformer-global-storage");
...
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: Number }),
    tslib_1.__metadata("design:type", Number)
], FindManyResponseMeta.prototype, "curPage", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: Number }),
    tslib_1.__metadata("design:type", Number)
], FindManyResponseMeta.prototype, "perPage", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: Number }),
    tslib_1.__metadata("design:type", Number)
], FindManyResponseMeta.prototype, "totalResults", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], StatusResponse.prototype, "message", void 0);
...
const prisma_1 = __webpack_require__(28);
const common_3 = __webpack_require__(7);
const core_1 = __webpack_require__(8);
const auth_client_1 = __webpack_require__(29);
const nestjs_translates_1 = __webpack_require__(30);
const auth_constants_1 = __webpack_require__(4);
const auth_decorators_1 = __webpack_require__(5);
const auth_environments_1 = __webpack_require__(31);
const auth_errors_1 = __webpack_require__(32);
const auth_cache_service_1 = __webpack_require__(33);
let AuthGuard = AuthGuard_1 = class AuthGuard {
    constructor(prismaClient, reflector, authCacheService, authEnvironments, translatesStorage) {
    ...
    async canActivate(context) {
        ...
        try {
            ...
            if (req.supabaseUser?.id) {
                await this.tryGetOrCreateCurrentUserWithExternalUserId(req, req.supabaseUser.id);
            }
    ...
    throwErrorIfCurrentUserNotSet(req, allowEmptyUserMetadata) {
        if (!req.skippedBySupabase && !req.authUser && !allowEmptyUserMetadata) {
            throw new auth_errors_1.AuthError(auth_errors_1.AuthErrorEnum.USER_NOT_FOUND);
        }
    }
    async tryGetOrCreateCurrentUserWithExternalUserId(req, externalUserId) {
        ...
        if (req.headers[nestjs_translates_1.ACCEPT_LANGUAGE] &&
            !this.translatesStorage.locales.includes(req.headers[nestjs_translates_1.ACCEPT_LANGUAGE])) {
            req.headers[nestjs_translates_1.ACCEPT_LANGUAGE] = this.translatesStorage.defaultLocale;
        }
    }
    ...
    getHandlersReflectMetadata(context) {
        const allowEmptyUserMetadata = Boolean((typeof context.getHandler === 'function' &&
            ...
            undefined);
        const skipAuthGuard = (typeof context.getHandler === 'function' &&
            this.reflector.get(auth_decorators_1.SkipAuthGuard, context.getHandler())) ||
            (typeof context.getClass === 'function' &&
                this.reflector.get(auth_decorators_1.SkipAuthGuard, context.getClass())) ||
            undefined;
        const checkAuthRole = (typeof context.getHandler === 'function' &&
            this.reflector.get(auth_decorators_1.CheckAuthRole, context.getHandler())) ||
            (typeof context.getClass === 'function' &&
                this.reflector.get(auth_decorators_1.CheckAuthRole, context.getClass())) ||
            undefined;
...
exports.AuthGuard = AuthGuard = AuthGuard_1 = tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(auth_constants_1.AUTH_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof auth_client_1.PrismaClient !== "undefined" && auth_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof core_1.Reflector !== "undefined" && core_1.Reflector) === "function" ? _b : Object, typeof (_c = typeof auth_cache_service_1.AuthCacheService !== "undefined" && auth_cache_service_1.AuthCacheService) === "function" ? _c : Object, typeof (_d = typeof auth_environments_1.AuthEnvironments !== "undefined" && auth_environments_1.AuthEnvironments) === "function" ? _d : Object, typeof (_e = typeof nestjs_translates_1.TranslatesStorage !== "undefined" && nestjs_translates_1.TranslatesStorage) === "function" ? _e : Object])
], AuthGuard);
...
"use strict";
module.exports = require("@nestjs-mod/prisma");
...
"use strict";
module.exports = require("@prisma/auth-client");
...
"use strict";
module.exports = require("nestjs-translates");
...
const tslib_1 = __webpack_require__(1);
const keyv_1 = __webpack_require__(34);
const prisma_1 = __webpack_require__(28);
const common_1 = __webpack_require__(7);
const auth_client_1 = __webpack_require__(29);
const auth_constants_1 = __webpack_require__(4);
...
let AuthCacheService = class AuthCacheService {
    ...
    async getCachedUserByExternalUserId(externalUserId) {
        const cached = await this.keyvService.get(this.getUserCacheKey({
            externalUserId,
        }));
        if (cached) {
            return cached;
        ...
        if (user) {
            await this.keyvService.set(this.getUserCacheKey({ externalUserId }), user, this.authEnvironments.cacheTTL);
            return user;
        }
        return null;
    }
...
exports.AuthCacheService = AuthCacheService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(auth_constants_1.AUTH_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof auth_client_1.PrismaClient !== "undefined" && auth_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof keyv_1.KeyvService !== "undefined" && keyv_1.KeyvService) === "function" ? _b : Object, typeof (_c = typeof auth_environments_1.AuthEnvironments !== "undefined" && auth_environments_1.AuthEnvironments) === "function" ? _c : Object])
], AuthCacheService);
...
"use strict";
module.exports = require("@nestjs-mod/keyv");
...
const operators_1 = __webpack_require__(37);
const auth_cache_service_1 = __webpack_require__(33);
const auth_timezone_service_1 = __webpack_require__(38);
const auth_environments_1 = __webpack_require__(31);
const node_async_hooks_1 = __webpack_require__(40);
...
exports.AuthTimezoneInterceptor = AuthTimezoneInterceptor = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof auth_timezone_service_1.AuthTimezoneService !== "undefined" && auth_timezone_service_1.AuthTimezoneService) === "function" ? _a : Object, typeof (_b = typeof auth_cache_service_1.AuthCacheService !== "undefined" && auth_cache_service_1.AuthCacheService) === "function" ? _b : Object, typeof (_c = typeof auth_environments_1.AuthEnvironments !== "undefined" && auth_environments_1.AuthEnvironments) === "function" ? _c : Object, typeof (_d = typeof node_async_hooks_1.AsyncLocalStorage !== "undefined" && node_async_hooks_1.AsyncLocalStorage) === "function" ? _d : Object])
...
let AuthExceptionsFilter = AuthExceptionsFilter_1 = class AuthExceptionsFilter extends core_1.BaseExceptionFilter {
...
exports.AuthExceptionsFilter = AuthExceptionsFilter = AuthExceptionsFilter_1 = tslib_1.__decorate([
    (0, common_1.Catch)(common_2.SupabaseError),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof auth_environments_1.AuthEnvironments !== "undefined" && auth_environments_1.AuthEnvironments) === "function" ? _a : Object])
...
const common_1 = __webpack_require__(9);
const prisma_tools_1 = __webpack_require__(43);
const common_2 = __webpack_require__(6);
const keyv_1 = __webpack_require__(34);
const prisma_1 = __webpack_require__(28);
const core_1 = __webpack_require__(8);
...
const auth_constants_1 = __webpack_require__(4);
const auth_environments_1 = __webpack_require__(31);
const auth_filter_1 = __webpack_require__(41);
const auth_guard_1 = __webpack_require__(27);
const auth_users_controller_1 = __webpack_require__(51);
const auth_controller_1 = __webpack_require__(72);
const auth_timezone_interceptor_1 = __webpack_require__(35);
const auth_timezone_pipe_1 = __webpack_require__(76);
const auth_cache_service_1 = __webpack_require__(33);
const auth_supabase_bootstrap_service_1 = __webpack_require__(77);
const auth_supabase_service_1 = __webpack_require__(78);
const auth_timezone_service_1 = __webpack_require__(38);
exports.AuthModule = (0, common_2.createNestModule)({
    ...
    controllers: [auth_controller_1.AuthController, auth_users_controller_1.AuthUsersController],
    sharedImports: [
        prisma_1.PrismaModule.forFeature({
            contextName: auth_constants_1.AUTH_FEATURE,
            featureModuleName: auth_constants_1.AUTH_FEATURE,
    ...
    providers: [
        ...
        { provide: core_1.APP_FILTER, useClass: auth_filter_1.AuthExceptionsFilter },
        { provide: core_1.APP_INTERCEPTOR, useClass: auth_timezone_interceptor_1.AuthTimezoneInterceptor },
        { provide: core_1.APP_PIPE, useClass: auth_timezone_pipe_1.AuthTimezonePipe },
    ...
    wrapForRootAsync: (asyncModuleOptions) => {
        ...
        const FomatterClass = (0, common_2.getFeatureDotEnvPropertyNameFormatter)(auth_constants_1.AUTH_FEATURE);
...
const common_1 = __webpack_require__(7);
const core_1 = __webpack_require__(8);
const prisma_tools_environments_1 = __webpack_require__(45);
const prisma_tools_service_1 = __webpack_require__(48);
...
exports.PrismaToolsExceptionsFilter = PrismaToolsExceptionsFilter = PrismaToolsExceptionsFilter_1 = tslib_1.__decorate([
    (0, common_1.Catch)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof prisma_tools_service_1.PrismaToolsService !== "undefined" && prisma_tools_service_1.PrismaToolsService) === "function" ? _a : Object, typeof (_b = typeof prisma_tools_environments_1.PrismaToolsEnvironments !== "undefined" && prisma_tools_environments_1.PrismaToolsEnvironments) === "function" ? _b : Object])
...
const prisma_tools_environments_1 = __webpack_require__(45);
const prisma_tools_errors_1 = __webpack_require__(46);
...
exports.PrismaToolsService = PrismaToolsService = PrismaToolsService_1 = tslib_1.__decorate([
    (0, common_1.ConfigModel)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof prisma_tools_environments_1.PrismaToolsEnvironments !== "undefined" && prisma_tools_environments_1.PrismaToolsEnvironments) === "function" ? _a : Object])
], PrismaToolsService);
...
const common_1 = __webpack_require__(6);
const prisma_tools_constants_1 = __webpack_require__(44);
const prisma_tools_environments_1 = __webpack_require__(45);
const prisma_tools_service_1 = __webpack_require__(48);
const core_1 = __webpack_require__(8);
const prisma_tools_filter_1 = __webpack_require__(47);
...
const auth_client_1 = __webpack_require__(29);
const prisma_tools_1 = __webpack_require__(43);
const validation_1 = __webpack_require__(52);
const prisma_1 = __webpack_require__(28);
const common_2 = __webpack_require__(7);
const swagger_1 = __webpack_require__(23);
const class_validator_multi_lang_1 = __webpack_require__(15);
...
const auth_decorators_1 = __webpack_require__(5);
const auth_errors_1 = __webpack_require__(32);
const auth_user_entity_1 = __webpack_require__(59);
const update_auth_user_dto_1 = __webpack_require__(70);
const auth_cache_service_1 = __webpack_require__(33);
const find_many_auth_user_response_1 = __webpack_require__(71);
        ...
        const result = await this.prismaClient.$transaction(async (prisma) => {
            return {
                authUsers: await prisma.authUser.findMany({
                    where: {
                        ...((0, class_validator_multi_lang_1.isUUID)(searchText)
                            ? {
                                OR: [
...
tslib_1.__decorate([
    (0, common_2.Get)(),
    (0, swagger_1.ApiOkResponse)({ type: find_many_auth_user_response_1.FindManyAuthUserResponse }),
    tslib_1.__param(0, (0, auth_decorators_1.CurrentAuthUser)()),
    tslib_1.__param(1, (0, common_2.Query)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_d = typeof auth_user_entity_1.AuthUser !== "undefined" && auth_user_entity_1.AuthUser) === "function" ? _d : Object, typeof (_e = typeof common_1.FindManyArgs !== "undefined" && common_1.FindManyArgs) === "function" ? _e : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AuthUsersController.prototype, "findMany", null);
tslib_1.__decorate([
    (0, common_2.Put)(':id'),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_f = typeof auth_user_entity_1.AuthUser !== "undefined" && auth_user_entity_1.AuthUser) === "function" ? _f : Object, String, typeof (_g = typeof update_auth_user_dto_1.UpdateAuthUserDto !== "undefined" && update_auth_user_dto_1.UpdateAuthUserDto) === "function" ? _g : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AuthUsersController.prototype, "updateOne", null);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_h = typeof auth_user_entity_1.AuthUser !== "undefined" && auth_user_entity_1.AuthUser) === "function" ? _h : Object, String, typeof (_j = typeof nestjs_translates_1.TranslateFunction !== "undefined" && nestjs_translates_1.TranslateFunction) === "function" ? _j : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AuthUsersController.prototype, "deleteOne", null);
tslib_1.__decorate([
    (0, common_2.Get)(':id'),
    (0, swagger_1.ApiOkResponse)({ type: auth_user_entity_1.AuthUser }),
    tslib_1.__param(0, (0, auth_decorators_1.CurrentAuthUser)()),
    tslib_1.__param(1, (0, common_2.Param)('id', new common_2.ParseUUIDPipe())),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_k = typeof auth_user_entity_1.AuthUser !== "undefined" && auth_user_entity_1.AuthUser) === "function" ? _k : Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
], AuthUsersController.prototype, "findOne", null);
exports.AuthUsersController = AuthUsersController = tslib_1.__decorate([
    (0, swagger_1.ApiExtraModels)(auth_errors_1.AuthError, validation_1.ValidationError),
    (0, swagger_1.ApiBadRequestResponse)({
        schema: { allOf: (0, swagger_1.refs)(auth_errors_1.AuthError, validation_1.ValidationError) },
    }),
    (0, swagger_1.ApiTags)('Auth'),
    (0, auth_decorators_1.CheckAuthRole)([auth_client_1.AuthRole.Admin]),
    (0, common_2.Controller)('/auth/users'),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(auth_constants_1.AUTH_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof auth_client_1.PrismaClient !== "undefined" && auth_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof prisma_tools_1.PrismaToolsService !== "undefined" && prisma_tools_1.PrismaToolsService) === "function" ? _b : Object, typeof (_c = typeof auth_cache_service_1.AuthCacheService !== "undefined" && auth_cache_service_1.AuthCacheService) === "function" ? _c : Object])
], AuthUsersController);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof common_2.ValidationPipeOptions !== "undefined" && common_2.ValidationPipeOptions) === "function" ? _a : Object)
], ValidationConfiguration.prototype, "pipeOptions", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.VALIDATION_FOLDER = exports.VALIDATION_MODULE = exports.VALIDATION_FEATURE = void 0;
exports.VALIDATION_FEATURE = 'validation';
exports.VALIDATION_MODULE = 'ValidationModule';
exports.VALIDATION_FOLDER = 'libs/core/validation';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ValidationError = exports.ValidationErrorMetadata = exports.ValidationErrorMetadataConstraint = exports.VALIDATION_ERROR_ENUM_TITLES = exports.ValidationErrorEnum = void 0;
const tslib_1 = __webpack_require__(1);
const swagger_1 = __webpack_require__(23);
const nestjs_translates_1 = __webpack_require__(30);
...
})(ValidationErrorEnum || (exports.ValidationErrorEnum = ValidationErrorEnum = {}));
exports.VALIDATION_ERROR_ENUM_TITLES = {
    [ValidationErrorEnum.COMMON]: (0, nestjs_translates_1.getText)('Validation error'),
};
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], ValidationErrorMetadataConstraint.prototype, "name", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: String,
    }),
    tslib_1.__metadata("design:type", String)
], ValidationErrorMetadataConstraint.prototype, "description", void 0);
class ValidationErrorMetadata {
    constructor(options) {
        Object.assign(this, options);
    }
    static fromClassValidatorValidationErrors(errors) {
        return errors?.map((error) => new ValidationErrorMetadata({
            property: error.property,
            constraints: Object.entries(error.constraints || {}).map(([key, value]) => new ValidationErrorMetadataConstraint({
                name: key,
                description: value,
            })),
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], ValidationErrorMetadata.prototype, "property", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    tslib_1.__metadata("design:type", Array)
], ValidationErrorMetadata.prototype, "constraints", void 0);
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Array)
], ValidationErrorMetadata.prototype, "children", void 0);
class ValidationError extends Error {
    constructor(message, code, metadata) {
        const messageAsCode = Boolean(message &&
            Object.values(ValidationErrorEnum).includes(message));
...
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: ValidationErrorMetadata, isArray: true }),
    tslib_1.__metadata("design:type", Array)
], ValidationError.prototype, "metadata", void 0);
...
const common_1 = __webpack_require__(7);
const core_1 = __webpack_require__(8);
const validation_errors_1 = __webpack_require__(56);
...
const common_2 = __webpack_require__(7);
const core_1 = __webpack_require__(8);
const validation_configuration_1 = __webpack_require__(53);
const validation_constants_1 = __webpack_require__(54);
const validation_environments_1 = __webpack_require__(55);
const validation_filter_1 = __webpack_require__(57);
const validation_errors_1 = __webpack_require__(56);
exports.ValidationModule = (0, common_1.createNestModule)({
        ...
        if (staticEnvironments.usePipes) {
            providers.push({
                ...
                useValue: new common_2.ValidationPipe({
                    ...
                    exceptionFactory: (errors) => new validation_errors_1.ValidationError(validation_errors_1.ValidationErrorEnum.COMMON, undefined, errors),
                }),
            });
        }
    ...
    wrapForRootAsync: (asyncModuleOptions) => {
        ...
        const FomatterClass = (0, common_1.getFeatureDotEnvPropertyNameFormatter)(validation_constants_1.VALIDATION_FEATURE);
        Object.assign(asyncModuleOptions, {
            environmentsOptions: {
                propertyNameFormatters: [new FomatterClass()],
...
const tslib_1 = __webpack_require__(1);
const auth_client_1 = __webpack_require__(60);
const swagger_1 = __webpack_require__(23);
class AuthUser {
}
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], AuthUser.prototype, "externalUserId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: auth_client_1.AuthRole,
        enumName: 'AuthRole',
    }),
    tslib_1.__metadata("design:type", typeof (_a = typeof auth_client_1.AuthRole !== "undefined" && auth_client_1.AuthRole) === "function" ? _a : Object)
], AuthUser.prototype, "userRole", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'number',
        format: 'float',
    ...
    tslib_1.__metadata("design:type", Object)
], AuthUser.prototype, "timezone", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Object)
], AuthUser.prototype, "lang", void 0);
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/endy/Projects/nestjs-mod/nestjs-mod-fullstack/node_modules/@prisma/auth-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/endy/Projects/nestjs-mod/nestjs-mod-fullstack/libs/core/auth/src/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "relativePath": "../../../libs/core/auth/src/prisma",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "SERVER_AUTH_DATABASE_URL",
        "value": null
      }
    }
  },
  ...
  "inlineSchemaHash": "5ae0a91f5f76be4e6af9b2054b5f3b53e36897e587e9ca67723962f4edd89a31",
  "copyEngine": true
}
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"AuthUser\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":{\"name\":\"dbgenerated\",\"args\":[\"uuid_generate_v4()\"]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"externalUserId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":true,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"userRole\",\"kind\":\"enum\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"AuthRole\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"timezone\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Float\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"lang\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"migrations\":{\"dbName\":\"__migrations\",\"fields\":[{\"name\":\"installed_rank\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"version\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"description\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"type\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"script\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"checksum\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"installed_by\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"installed_on\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"execution_time\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"success\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Boolean\",\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false}},\"enums\":{\"AuthRole\":{\"values\":[{\"name\":\"Admin\",\"dbName\":null},{\"name\":\"User\",\"dbName\":null}],\"dbName\":null}},\"types\":{}}")
defineDmmfProperty(exports.Prisma, config.runtimeDataModel)
config.engineWasm = undefined


const { warnEnvConflicts } = __webpack_require__(61)
...
path.join(process.cwd(), "node_modules/@prisma/auth-client/libquery_engine-debian-openssl-1.1.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl.so.node");
path.join(process.cwd(), "node_modules/@prisma/auth-client/libquery_engine-linux-musl.so.node")
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsOptional)(),
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Array)
], FindManyAuthUserResponse.prototype, "authUsers", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: () => common_1.FindManyResponseMeta }),
    tslib_1.__metadata("design:type", typeof (_a = typeof common_1.FindManyResponseMeta !== "undefined" && common_1.FindManyResponseMeta) === "function" ? _a : Object)
], FindManyAuthUserResponse.prototype, "meta", void 0);
...
const auth_user_entity_1 = __webpack_require__(59);
const auth_cache_service_1 = __webpack_require__(33);
const auth_entities_1 = __webpack_require__(73);
const auth_profile_dto_1 = __webpack_require__(74);
let AuthController = class AuthController {
    ...
    async updateProfile(authUser, args, getText) {
        if (args.lang && !this.translatesStorage.locales.includes(args.lang)) {
            throw new validation_1.ValidationError(undefined, validation_1.ValidationErrorEnum.COMMON, [
                {
                    property: 'lang',
                    constraints: {
                        isWrongEnumValue: getText('lang must have one of the values: {{values}}', { values: this.translatesStorage.locales.join(', ') }),
                    },
                },
            ]);
        }
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, auth_decorators_1.CurrentAuthUser)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_d = typeof auth_user_entity_1.AuthUser !== "undefined" && auth_user_entity_1.AuthUser) === "function" ? _d : Object]),
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, nestjs_translates_1.InjectTranslateFunction)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_f = typeof auth_user_entity_1.AuthUser !== "undefined" && auth_user_entity_1.AuthUser) === "function" ? _f : Object, typeof (_g = typeof auth_profile_dto_1.AuthProfileDto !== "undefined" && auth_profile_dto_1.AuthProfileDto) === "function" ? _g : Object, typeof (_h = typeof nestjs_translates_1.TranslateFunction !== "undefined" && nestjs_translates_1.TranslateFunction) === "function" ? _h : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AuthController.prototype, "updateProfile", null);
exports.AuthController = AuthController = tslib_1.__decorate([
    (0, swagger_1.ApiExtraModels)(auth_errors_1.AuthError, auth_entities_1.AuthEntities, validation_1.ValidationError),
    (0, swagger_1.ApiBadRequestResponse)({
        schema: { allOf: (0, swagger_1.refs)(auth_errors_1.AuthError, validation_1.ValidationError) },
    }),
    (0, swagger_1.ApiTags)('Auth'),
    (0, auth_decorators_1.CheckAuthRole)([auth_client_1.AuthRole.User, auth_client_1.AuthRole.Admin]),
    (0, common_2.Controller)('/auth'),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(auth_constants_1.AUTH_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof auth_client_1.PrismaClient !== "undefined" && auth_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof auth_cache_service_1.AuthCacheService !== "undefined" && auth_cache_service_1.AuthCacheService) === "function" ? _b : Object, typeof (_c = typeof nestjs_translates_1.TranslatesStorage !== "undefined" && nestjs_translates_1.TranslatesStorage) === "function" ? _c : Object])
], AuthController);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof auth_client_1.Prisma !== "undefined" && auth_client_1.Prisma.AuthUserScalarFieldEnum) === "function" ? _a : Object)
], AuthEntities.prototype, "authUser", void 0);
...
const auth_client_1 = __webpack_require__(29);
const class_validator_multi_lang_1 = __webpack_require__(15);
const create_auth_user_dto_1 = __webpack_require__(75);
...
let AuthTimezonePipe = class AuthTimezonePipe {
    ...
    transform(value) {
        ...
        const result = this.authTimezoneService.convertObject(value, -1 * (this.asyncLocalStorage.getStore()?.authTimezone || 0) -
...
exports.AuthTimezonePipe = AuthTimezonePipe = tslib_1.__decorate([
    (0, common_2.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof node_async_hooks_1.AsyncLocalStorage !== "undefined" && node_async_hooks_1.AsyncLocalStorage) === "function" ? _a : Object, typeof (_b = typeof auth_timezone_service_1.AuthTimezoneService !== "undefined" && auth_timezone_service_1.AuthTimezoneService) === "function" ? _b : Object, typeof (_c = typeof auth_environments_1.AuthEnvironments !== "undefined" && auth_environments_1.AuthEnvironments) === "function" ? _c : Object])
], AuthTimezonePipe);
...
exports.AuthSupabaseBootstrapService = AuthSupabaseBootstrapService = AuthSupabaseBootstrapService_1 = tslib_1.__decorate([
    (0, common_2.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof auth_supabase_service_1.AuthSupabaseService !== "undefined" && auth_supabase_service_1.AuthSupabaseService) === "function" ? _a : Object, typeof (_b = typeof auth_environments_1.AuthEnvironments !== "undefined" && auth_environments_1.AuthEnvironments) === "function" ? _b : Object])
...
exports.AuthSupabaseService = AuthSupabaseService = AuthSupabaseService_1 = tslib_1.__decorate([
    (0, common_2.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof common_1.SupabaseService !== "undefined" && common_1.SupabaseService) === "function" ? _a : Object])
], AuthSupabaseService);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], AuthUserDto.prototype, "externalUserId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: auth_client_1.AuthRole,
        enumName: 'AuthRole',
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof auth_client_1.AuthRole !== "undefined" && auth_client_1.AuthRole) === "function" ? _a : Object)
], AuthUserDto.prototype, "userRole", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'number',
        format: 'float',
    ...
    tslib_1.__metadata("design:type", Object)
], AuthUserDto.prototype, "timezone", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Object)
], AuthUserDto.prototype, "lang", void 0);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsNotEmpty)(),
    (0, class_validator_multi_lang_1.IsInt)(),
    tslib_1.__metadata("design:type", Number)
], ConnectMigrationsDto.prototype, "installed_rank", void 0);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsInt)(),
    tslib_1.__metadata("design:type", Number)
], CreateMigrationsDto.prototype, "installed_rank", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", Object)
], CreateMigrationsDto.prototype, "version", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], CreateMigrationsDto.prototype, "description", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], CreateMigrationsDto.prototype, "type", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], CreateMigrationsDto.prototype, "script", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'integer',
        format: 'int32',
    ...
    (0, class_validator_multi_lang_1.IsInt)(),
    tslib_1.__metadata("design:type", Object)
], CreateMigrationsDto.prototype, "checksum", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], CreateMigrationsDto.prototype, "installed_by", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'integer',
        format: 'int32',
    ...
    (0, class_validator_multi_lang_1.IsInt)(),
    tslib_1.__metadata("design:type", Number)
], CreateMigrationsDto.prototype, "execution_time", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'boolean',
    }),
    (0, class_validator_multi_lang_1.IsNotEmpty)(),
    (0, class_validator_multi_lang_1.IsBoolean)(),
    tslib_1.__metadata("design:type", Boolean)
], CreateMigrationsDto.prototype, "success", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Number)
], Migrations.prototype, "installed_rank", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        nullable: true,
    ...
    tslib_1.__metadata("design:type", Object)
], Migrations.prototype, "version", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], Migrations.prototype, "description", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], Migrations.prototype, "type", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], Migrations.prototype, "script", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'integer',
        format: 'int32',
    ...
    tslib_1.__metadata("design:type", Object)
], Migrations.prototype, "checksum", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], Migrations.prototype, "installed_by", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof Date !== "undefined" && Date) === "function" ? _a : Object)
], Migrations.prototype, "installed_on", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'integer',
        format: 'int32',
    ...
    tslib_1.__metadata("design:type", Number)
], Migrations.prototype, "execution_time", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'boolean',
    }),
    tslib_1.__metadata("design:type", Boolean)
], Migrations.prototype, "success", void 0);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", Object)
], UpdateMigrationsDto.prototype, "version", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateMigrationsDto.prototype, "description", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateMigrationsDto.prototype, "type", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateMigrationsDto.prototype, "script", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'integer',
        format: 'int32',
    ...
    (0, class_validator_multi_lang_1.IsInt)(),
    tslib_1.__metadata("design:type", Object)
], UpdateMigrationsDto.prototype, "checksum", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateMigrationsDto.prototype, "installed_by", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'integer',
        format: 'int32',
    ...
    (0, class_validator_multi_lang_1.IsInt)(),
    tslib_1.__metadata("design:type", Number)
], UpdateMigrationsDto.prototype, "execution_time", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'boolean',
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsBoolean)(),
    tslib_1.__metadata("design:type", Boolean)
], UpdateMigrationsDto.prototype, "success", void 0);
...
exports.FILES_FOLDER = 'libs/core/files';
...
const common_1 = __webpack_require__(6);
const common_2 = __webpack_require__(7);
exports.CurrentFilesRequest = (0, common_2.createParamDecorator)((_data, ctx) => {
    const req = (0, common_1.getRequestFromExecutionContext)(ctx);
    return req;
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.FilesError = exports.FILES_ERROR_ENUM_TITLES = exports.FilesErrorEnum = void 0;
const tslib_1 = __webpack_require__(1);
const swagger_1 = __webpack_require__(23);
const nestjs_translates_1 = __webpack_require__(30);
var FilesErrorEnum;
...
class FilesError extends Error {
    constructor(message, code, metadata) {
        const messageAsCode = Boolean(message &&
            Object.values(FilesErrorEnum).includes(message));
        const preparedCode = messageAsCode ? message : code;
        const preparedMessage = preparedCode
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], FilesError.prototype, "message", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: FilesErrorEnum,
    ...
    tslib_1.__metadata("design:type", Object)
], FilesError.prototype, "code", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: Object }),
    tslib_1.__metadata("design:type", Object)
], FilesError.prototype, "metadata", void 0);
...
const common_1 = __webpack_require__(6);
const minio_1 = __webpack_require__(93);
const files_controller_1 = __webpack_require__(94);
const files_constants_1 = __webpack_require__(89);
const common_2 = __webpack_require__(9);
...
"use strict";
module.exports = require("@nestjs-mod/minio");
...
const class_validator_multi_lang_1 = __webpack_require__(15);
const nestjs_translates_1 = __webpack_require__(30);
const node_crypto_1 = __webpack_require__(95);
const files_decorators_1 = __webpack_require__(90);
const files_errors_1 = __webpack_require__(91);
const files_request_1 = __webpack_require__(96);
const files_role_1 = __webpack_require__(97);
class GetPresignedUrlArgs {
}
exports.GetPresignedUrlArgs = GetPresignedUrlArgs;
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: String }),
    (0, class_validator_multi_lang_1.IsDefined)(),
    tslib_1.__metadata("design:type", String)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, nestjs_translates_1.InjectTranslateFunction)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [GetPresignedUrlArgs, typeof (_e = typeof files_request_1.FilesRequest !== "undefined" && files_request_1.FilesRequest) === "function" ? _e : Object, typeof (_f = typeof nestjs_translates_1.TranslateFunction !== "undefined" && nestjs_translates_1.TranslateFunction) === "function" ? _f : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, nestjs_translates_1.InjectTranslateFunction)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [DeleteFileArgs, typeof (_g = typeof files_request_1.FilesRequest !== "undefined" && files_request_1.FilesRequest) === "function" ? _g : Object, typeof (_h = typeof nestjs_translates_1.TranslateFunction !== "undefined" && nestjs_translates_1.TranslateFunction) === "function" ? _h : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
exports.FilesController = FilesController = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof minio_1.MinioEnvironments !== "undefined" && minio_1.MinioEnvironments) === "function" ? _a : Object, typeof (_b = typeof minio_1.MinioConfiguration !== "undefined" && minio_1.MinioConfiguration) === "function" ? _b : Object, typeof (_c = typeof common_2.SupabaseService !== "undefined" && common_2.SupabaseService) === "function" ? _c : Object, typeof (_d = typeof minio_1.MinioFilesService !== "undefined" && minio_1.MinioFilesService) === "function" ? _d : Object])
], FilesController);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.FilesRole = void 0;
var FilesRole;
(function (FilesRole) {
    FilesRole["Admin"] = "Admin";
    FilesRole["User"] = "User";
})(FilesRole || (exports.FilesRole = FilesRole = {}));
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Number)
], WebhookConfiguration.prototype, "cacheTTL", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], WebhookStaticConfiguration.prototype, "externalUserIdHeaderName", void 0);
tslib_1.__decorate([
    (0, common_1.ConfigModelProperty)({
    ...
    tslib_1.__metadata("design:type", String)
], WebhookStaticConfiguration.prototype, "externalTenantIdHeaderName", void 0);
...
const common_2 = __webpack_require__(7);
const core_1 = __webpack_require__(8);
const webhook_client_1 = __webpack_require__(102);
const webhook_errors_1 = __webpack_require__(103);
...
"use strict";
module.exports = require("@prisma/webhook-client");
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.WebhookError = exports.WEBHOOK_ERROR_ENUM_TITLES = exports.WebhookErrorEnum = void 0;
const tslib_1 = __webpack_require__(1);
const swagger_1 = __webpack_require__(23);
const nestjs_translates_1 = __webpack_require__(30);
...
exports.WEBHOOK_ERROR_ENUM_TITLES = {
    ...
    [WebhookErrorEnum.EXTERNAL_TENANT_ID_NOT_SET]: (0, nestjs_translates_1.getText)('Tenant ID not set'),
    [WebhookErrorEnum.EXTERNAL_USER_ID_NOT_SET]: (0, nestjs_translates_1.getText)('User ID not set'),
    [WebhookErrorEnum.FORBIDDEN]: (0, nestjs_translates_1.getText)('Forbidden'),
    [WebhookErrorEnum.USER_NOT_FOUND]: (0, nestjs_translates_1.getText)('User not found'),
    [WebhookErrorEnum.EVENT_NOT_FOUND]: (0, nestjs_translates_1.getText)('Event not found'),
};
class WebhookError extends Error {
    constructor(message, code, metadata) {
        const messageAsCode = Boolean(message &&
            Object.values(WebhookErrorEnum).includes(message));
        const preparedCode = messageAsCode ? message : code;
        const preparedMessage = preparedCode
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], WebhookError.prototype, "message", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    tslib_1.__metadata("design:type", Object)
], WebhookError.prototype, "code", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: Object }),
    tslib_1.__metadata("design:type", Object)
], WebhookError.prototype, "metadata", void 0);
...
const core_1 = __webpack_require__(8);
const webhook_errors_1 = __webpack_require__(103);
let WebhookExceptionsFilter = WebhookExceptionsFilter_1 = class WebhookExceptionsFilter extends core_1.BaseExceptionFilter {
    constructor() {
        super(...arguments);
...
exports.WebhookExceptionsFilter = WebhookExceptionsFilter = WebhookExceptionsFilter_1 = tslib_1.__decorate([
...
const webhook_client_1 = __webpack_require__(102);
const class_validator_multi_lang_1 = __webpack_require__(15);
const webhook_cache_service_1 = __webpack_require__(107);
const webhook_configuration_1 = __webpack_require__(99);
const webhook_constants_1 = __webpack_require__(100);
const webhook_decorators_1 = __webpack_require__(101);
const webhook_environments_1 = __webpack_require__(104);
const webhook_errors_1 = __webpack_require__(103);
let WebhookGuard = WebhookGuard_1 = class WebhookGuard {
    ...
    async tryGetOrCreateCurrentUserWithExternalUserId(req, externalTenantId, externalUserId) {
        if (!req.webhookUser) {
            if (!externalTenantId || !(0, class_validator_multi_lang_1.isUUID)(externalTenantId)) {
                throw new webhook_errors_1.WebhookError(webhook_errors_1.WebhookErrorEnum.EXTERNAL_TENANT_ID_NOT_SET);
            }
    ...
    getExternalUserIdFromRequest(req) {
        ...
        if (!req.externalUserId || !(0, class_validator_multi_lang_1.isUUID)(req.externalUserId)) {
...
exports.WebhookGuard = WebhookGuard = WebhookGuard_1 = tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof webhook_client_1.PrismaClient !== "undefined" && webhook_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof core_1.Reflector !== "undefined" && core_1.Reflector) === "function" ? _b : Object, typeof (_c = typeof webhook_environments_1.WebhookEnvironments !== "undefined" && webhook_environments_1.WebhookEnvironments) === "function" ? _c : Object, typeof (_d = typeof webhook_configuration_1.WebhookStaticConfiguration !== "undefined" && webhook_configuration_1.WebhookStaticConfiguration) === "function" ? _d : Object, typeof (_e = typeof webhook_cache_service_1.WebhookCacheService !== "undefined" && webhook_cache_service_1.WebhookCacheService) === "function" ? _e : Object])
], WebhookGuard);
...
let WebhookCacheService = class WebhookCacheService {
    ...
    async getCachedUserByExternalUserId(externalUserId, externalTenantId) {
        ...
        if (user) {
            await this.keyvService.set(this.getUserCacheKey({ externalTenantId, externalUserId }), user, this.webhookConfiguration.cacheTTL);
            return user;
        }
        return null;
    }
...
exports.WebhookCacheService = WebhookCacheService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(webhook_constants_1.WEBHOOK_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof webhook_client_1.PrismaClient !== "undefined" && webhook_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof webhook_configuration_1.WebhookConfiguration !== "undefined" && webhook_configuration_1.WebhookConfiguration) === "function" ? _b : Object, typeof (_c = typeof keyv_1.KeyvService !== "undefined" && keyv_1.KeyvService) === "function" ? _c : Object])
], WebhookCacheService);
...
const common_2 = __webpack_require__(7);
const swagger_1 = __webpack_require__(23);
const webhook_users_controller_1 = __webpack_require__(110);
const webhook_controller_1 = __webpack_require__(119);
const webhook_bootstrap_service_1 = __webpack_require__(126);
const webhook_tools_service_1 = __webpack_require__(117);
const webhook_users_service_1 = __webpack_require__(130);
const webhook_service_1 = __webpack_require__(129);
const webhook_configuration_1 = __webpack_require__(99);
const webhook_constants_1 = __webpack_require__(100);
const webhook_environments_1 = __webpack_require__(104);
const webhook_filter_1 = __webpack_require__(105);
const webhook_guard_1 = __webpack_require__(106);
const keyv_1 = __webpack_require__(34);
const nestjs_translates_1 = __webpack_require__(30);
const webhook_cache_service_1 = __webpack_require__(107);
exports.WebhookModule = (0, common_1.createNestModule)({
    ...
    controllers: [webhook_users_controller_1.WebhookUsersController, webhook_controller_1.WebhookController],
    ...
    preWrapApplication: async ({ current }) => {
        ...
        for (const ctrl of [webhook_controller_1.WebhookController, webhook_users_controller_1.WebhookUsersController]) {
            if (staticEnvironments.useFilters) {
                (0, common_2.UseFilters)(webhook_filter_1.WebhookExceptionsFilter)(ctrl);
            }
            if (staticEnvironments.useGuards) {
                (0, common_2.UseGuards)(webhook_guard_1.WebhookGuard)(ctrl);
            }
            if (staticConfiguration.externalUserIdHeaderName &&
...
const swagger_1 = __webpack_require__(23);
const class_validator_multi_lang_1 = __webpack_require__(15);
const update_webhook_user_dto_1 = __webpack_require__(111);
const webhook_user_entity_1 = __webpack_require__(114);
const webhook_cache_service_1 = __webpack_require__(107);
const webhook_tools_service_1 = __webpack_require__(117);
const find_many_webhook_user_response_1 = __webpack_require__(118);
const webhook_constants_1 = __webpack_require__(100);
const webhook_decorators_1 = __webpack_require__(101);
const webhook_errors_1 = __webpack_require__(103);
const validation_1 = __webpack_require__(52);
...
let WebhookUsersController = class WebhookUsersController {
    constructor(prismaClient, prismaToolsService, webhookToolsService, webhookCacheService) {
        this.prismaClient = prismaClient;
        this.prismaToolsService = prismaToolsService;
...
tslib_1.__decorate([
    (0, common_2.Get)(),
    (0, swagger_1.ApiOkResponse)({ type: find_many_webhook_user_response_1.FindManyWebhookUserResponse }),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_e = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _e : Object, typeof (_f = typeof common_1.FindManyArgs !== "undefined" && common_1.FindManyArgs) === "function" ? _f : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], WebhookUsersController.prototype, "findMany", null);
tslib_1.__decorate([
    (0, common_2.Put)(':id'),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_g = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _g : Object, String, typeof (_h = typeof update_webhook_user_dto_1.UpdateWebhookUserDto !== "undefined" && update_webhook_user_dto_1.UpdateWebhookUserDto) === "function" ? _h : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], WebhookUsersController.prototype, "updateOne", null);
tslib_1.__decorate([
    (0, common_2.Delete)(':id'),
    (0, swagger_1.ApiOkResponse)({ type: common_1.StatusResponse }),
    tslib_1.__param(0, (0, webhook_decorators_1.CurrentWebhookExternalTenantId)()),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_j = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _j : Object, String, typeof (_k = typeof nestjs_translates_1.TranslateFunction !== "undefined" && nestjs_translates_1.TranslateFunction) === "function" ? _k : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], WebhookUsersController.prototype, "deleteOne", null);
tslib_1.__decorate([
    (0, common_2.Get)(':id'),
    (0, swagger_1.ApiOkResponse)({ type: webhook_user_entity_1.WebhookUser }),
    tslib_1.__param(0, (0, webhook_decorators_1.CurrentWebhookExternalTenantId)()),
    ...
    tslib_1.__param(2, (0, common_2.Param)('id', new common_2.ParseUUIDPipe())),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_l = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _l : Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
], WebhookUsersController.prototype, "findOne", null);
exports.WebhookUsersController = WebhookUsersController = tslib_1.__decorate([
    (0, swagger_1.ApiExtraModels)(webhook_errors_1.WebhookError, validation_1.ValidationError),
    (0, swagger_1.ApiBadRequestResponse)({
        schema: { allOf: (0, swagger_1.refs)(webhook_errors_1.WebhookError, validation_1.ValidationError) },
    }),
    (0, swagger_1.ApiTags)('Webhook'),
    (0, webhook_decorators_1.CheckWebhookRole)([webhook_client_1.WebhookRole.Admin]),
    (0, common_2.Controller)('/webhook/users'),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(webhook_constants_1.WEBHOOK_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof webhook_client_1.PrismaClient !== "undefined" && webhook_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof prisma_tools_1.PrismaToolsService !== "undefined" && prisma_tools_1.PrismaToolsService) === "function" ? _b : Object, typeof (_c = typeof webhook_tools_service_1.WebhookToolsService !== "undefined" && webhook_tools_service_1.WebhookToolsService) === "function" ? _c : Object, typeof (_d = typeof webhook_cache_service_1.WebhookCacheService !== "undefined" && webhook_cache_service_1.WebhookCacheService) === "function" ? _d : Object])
...
const tslib_1 = __webpack_require__(1);
const webhook_client_1 = __webpack_require__(112);
const swagger_1 = __webpack_require__(23);
const class_validator_multi_lang_1 = __webpack_require__(15);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateWebhookUserDto.prototype, "externalTenantId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], UpdateWebhookUserDto.prototype, "externalUserId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_multi_lang_1.IsOptional)(),
    tslib_1.__metadata("design:type", typeof (_a = typeof webhook_client_1.WebhookRole !== "undefined" && webhook_client_1.WebhookRole) === "function" ? _a : Object)
], UpdateWebhookUserDto.prototype, "userRole", void 0);
...
exports.Prisma.WebhookUserScalarFieldEnum = {
  id: 'id',
  externalTenantId: 'externalTenantId',
  externalUserId: 'externalUserId',
  userRole: 'userRole',
...
exports.WebhookRole = exports.$Enums.WebhookRole = {
  Admin: 'Admin',
  User: 'User'
};
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/endy/Projects/nestjs-mod/nestjs-mod-fullstack/node_modules/@prisma/webhook-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/endy/Projects/nestjs-mod/nestjs-mod-fullstack/libs/feature/webhook/src/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "relativePath": "../../../libs/feature/webhook/src/prisma",
  "clientVersion": "5.22.0",
  "engineVersion": "605197351a3c8bdd595af2d2a9bc3025bca48ea2",
  "datasourceNames": [
    "db"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": "SERVER_WEBHOOK_DATABASE_URL",
        "value": null
      }
    }
  },
  ...
  "inlineSchemaHash": "76e002e212936b73fc7e9fb7c25040f1206ac466baea882ef5ba285e69d54a34",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "node_modules/@prisma/webhook-client",
    "@prisma/webhook-client",
  ]
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"Webhook\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":{\"name\":\"dbgenerated\",\"args\":[\"uuid_generate_v4()\"]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"eventName\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"endpoint\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"enabled\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Boolean\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"headers\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"requestTimeout\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"externalTenantId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"createdBy\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"updatedBy\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"workUntilDate\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"DateTime\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"WebhookUser_Webhook_createdByToWebhookUser\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"WebhookUser\",\"relationName\":\"Webhook_createdByToWebhookUser\",\"relationFromFields\":[\"createdBy\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"NoAction\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"WebhookUser_Webhook_updatedByToWebhookUser\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"WebhookUser\",\"relationName\":\"Webhook_updatedByToWebhookUser\",\"relationFromFields\":[\"updatedBy\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"NoAction\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"WebhookLog\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"WebhookLog\",\"relationName\":\"WebhookToWebhookLog\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"WebhookLog\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":{\"name\":\"dbgenerated\",\"args\":[\"uuid_generate_v4()\"]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"request\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"responseStatus\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"response\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Json\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"webhookStatus\",\"kind\":\"enum\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"WebhookStatus\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"webhookId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"externalTenantId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"Webhook\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Webhook\",\"relationName\":\"WebhookToWebhookLog\",\"relationFromFields\":[\"webhookId\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"NoAction\",\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"WebhookUser\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":{\"name\":\"dbgenerated\",\"args\":[\"uuid_generate_v4()\"]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"externalTenantId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"externalUserId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"userRole\",\"kind\":\"enum\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"WebhookRole\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false,\"documentation\":\"@DtoCreateHidden\\\\n@DtoUpdateHidden\"},{\"name\":\"Webhook_Webhook_createdByToWebhookUser\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Webhook\",\"relationName\":\"Webhook_createdByToWebhookUser\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"Webhook_Webhook_updatedByToWebhookUser\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Webhook\",\"relationName\":\"Webhook_updatedByToWebhookUser\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[[\"externalTenantId\",\"externalUserId\"]],\"uniqueIndexes\":[{\"name\":null,\"fields\":[\"externalTenantId\",\"externalUserId\"]}],\"isGenerated\":false},\"migrations\":{\"dbName\":\"__migrations\",\"fields\":[{\"name\":\"installed_rank\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"version\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"description\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"type\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"script\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"checksum\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"installed_by\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"installed_on\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"execution_time\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"success\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Boolean\",\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false}},\"enums\":{\"WebhookRole\":{\"values\":[{\"name\":\"Admin\",\"dbName\":null},{\"name\":\"User\",\"dbName\":null}],\"dbName\":null},\"WebhookStatus\":{\"values\":[{\"name\":\"Pending\",\"dbName\":null},{\"name\":\"Process\",\"dbName\":null},{\"name\":\"Success\",\"dbName\":null},{\"name\":\"Error\",\"dbName\":null},{\"name\":\"Timeout\",\"dbName\":null}],\"dbName\":null}},\"types\":{}}")
defineDmmfProperty(exports.Prisma, config.runtimeDataModel)
config.engineWasm = undefined


const { warnEnvConflicts } = __webpack_require__(113)
...
// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-1.1.x.so.node");
path.join(process.cwd(), "node_modules/@prisma/webhook-client/libquery_engine-debian-openssl-1.1.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl.so.node");
path.join(process.cwd(), "node_modules/@prisma/webhook-client/libquery_engine-linux-musl.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl-openssl-3.0.x.so.node");
path.join(process.cwd(), "node_modules/@prisma/webhook-client/libquery_engine-linux-musl-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "node_modules/@prisma/webhook-client/schema.prisma")
...
const webhook_client_1 = __webpack_require__(112);
const swagger_1 = __webpack_require__(23);
const webhook_entity_1 = __webpack_require__(115);
class WebhookUser {
}
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], WebhookUser.prototype, "id", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], WebhookUser.prototype, "externalTenantId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], WebhookUser.prototype, "externalUserId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: webhook_client_1.WebhookRole,
        enumName: 'WebhookRole',
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof webhook_client_1.WebhookRole !== "undefined" && webhook_client_1.WebhookRole) === "function" ? _a : Object)
], WebhookUser.prototype, "userRole", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
    ...
    tslib_1.__metadata("design:type", typeof (_b = typeof Date !== "undefined" && Date) === "function" ? _b : Object)
], WebhookUser.prototype, "createdAt", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
    ...
    tslib_1.__metadata("design:type", typeof (_c = typeof Date !== "undefined" && Date) === "function" ? _c : Object)
], WebhookUser.prototype, "updatedAt", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    tslib_1.__metadata("design:type", Array)
], WebhookUser.prototype, "Webhook_Webhook_createdByToWebhookUser", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: () => webhook_entity_1.Webhook,
        isArray: true,
    ...
    tslib_1.__metadata("design:type", Array)
], WebhookUser.prototype, "Webhook_Webhook_updatedByToWebhookUser", void 0);
...
const swagger_1 = __webpack_require__(23);
const webhook_user_entity_1 = __webpack_require__(114);
const webhook_log_entity_1 = __webpack_require__(116);
class Webhook {
}
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_e = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _e : Object)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_f = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _f : Object)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof webhook_client_1.Prisma !== "undefined" && webhook_client_1.Prisma.JsonValue) === "function" ? _a : Object)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_c = typeof webhook_client_1.WebhookStatus !== "undefined" && webhook_client_1.WebhookStatus) === "function" ? _c : Object)
], WebhookLog.prototype, "webhookStatus", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], WebhookLog.prototype, "webhookId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], WebhookLog.prototype, "externalTenantId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
...
], WebhookLog.prototype, "updatedAt", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: () => webhook_entity_1.Webhook,
        required: false,
    }),
    tslib_1.__metadata("design:type", typeof (_f = typeof webhook_entity_1.Webhook !== "undefined" && webhook_entity_1.Webhook) === "function" ? _f : Object)
], WebhookLog.prototype, "Webhook", void 0);
...
let WebhookToolsService = class WebhookToolsService {
    externalTenantIdQuery(webhookUser, externalTenantId) {
        const q = webhookUser?.userRole === 'User'
            ? {
...
const class_validator_multi_lang_1 = __webpack_require__(15);
const nestjs_translates_1 = __webpack_require__(30);
const create_webhook_dto_1 = __webpack_require__(120);
const update_webhook_dto_1 = __webpack_require__(121);
const webhook_user_entity_1 = __webpack_require__(114);
const webhook_entity_1 = __webpack_require__(115);
const webhook_tools_service_1 = __webpack_require__(117);
const find_many_webhook_log_response_1 = __webpack_require__(122);
const find_many_webhook_response_1 = __webpack_require__(123);
const webhook_entities_1 = __webpack_require__(124);
const webhook_event_1 = __webpack_require__(125);
const webhook_configuration_1 = __webpack_require__(99);
const webhook_constants_1 = __webpack_require__(100);
const webhook_decorators_1 = __webpack_require__(101);
const webhook_errors_1 = __webpack_require__(103);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_f = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _f : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, common_2.Query)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_g = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _g : Object, typeof (_h = typeof common_1.FindManyArgs !== "undefined" && common_1.FindManyArgs) === "function" ? _h : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, common_2.Body)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_j = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _j : Object, typeof (_k = typeof create_webhook_dto_1.CreateWebhookDto !== "undefined" && create_webhook_dto_1.CreateWebhookDto) === "function" ? _k : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(3, (0, common_2.Body)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_l = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _l : Object, String, typeof (_m = typeof update_webhook_dto_1.UpdateWebhookDto !== "undefined" && update_webhook_dto_1.UpdateWebhookDto) === "function" ? _m : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_o = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _o : Object, String, String]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__param(2, (0, common_2.Param)('id', new common_2.ParseUUIDPipe())),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_p = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _p : Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, typeof (_q = typeof webhook_user_entity_1.WebhookUser !== "undefined" && webhook_user_entity_1.WebhookUser) === "function" ? _q : Object, String, typeof (_r = typeof common_1.FindManyArgs !== "undefined" && common_1.FindManyArgs) === "function" ? _r : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
exports.WebhookController = WebhookController = tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(webhook_constants_1.WEBHOOK_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof webhook_client_1.PrismaClient !== "undefined" && webhook_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof webhook_configuration_1.WebhookConfiguration !== "undefined" && webhook_configuration_1.WebhookConfiguration) === "function" ? _b : Object, typeof (_c = typeof prisma_tools_1.PrismaToolsService !== "undefined" && prisma_tools_1.PrismaToolsService) === "function" ? _c : Object, typeof (_d = typeof webhook_tools_service_1.WebhookToolsService !== "undefined" && webhook_tools_service_1.WebhookToolsService) === "function" ? _d : Object, typeof (_e = typeof nestjs_translates_1.TranslatesService !== "undefined" && nestjs_translates_1.TranslatesService) === "function" ? _e : Object])
], WebhookController);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsOptional)(),
    (0, class_validator_multi_lang_1.IsDateString)(),
    tslib_1.__metadata("design:type", Object)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Array)
], FindManyWebhookResponse.prototype, "webhooks", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: () => common_1.FindManyResponseMeta }),
    tslib_1.__metadata("design:type", typeof (_a = typeof common_1.FindManyResponseMeta !== "undefined" && common_1.FindManyResponseMeta) === "function" ? _a : Object)
], FindManyWebhookResponse.prototype, "meta", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof webhook_client_1.Prisma !== "undefined" && webhook_client_1.Prisma.WebhookScalarFieldEnum) === "function" ? _a : Object)
], WebhookEntities.prototype, "webhook", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: webhook_client_1.Prisma.WebhookLogScalarFieldEnum,
        enumName: 'WebhookLogScalarFieldEnum',
    }),
    tslib_1.__metadata("design:type", typeof (_b = typeof webhook_client_1.Prisma !== "undefined" && webhook_client_1.Prisma.WebhookLogScalarFieldEnum) === "function" ? _b : Object)
], WebhookEntities.prototype, "webhookLog", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: webhook_client_1.Prisma.WebhookUserScalarFieldEnum,
        enumName: 'WebhookUserScalarFieldEnum',
    }),
    tslib_1.__metadata("design:type", typeof (_c = typeof webhook_client_1.Prisma !== "undefined" && webhook_client_1.Prisma.WebhookUserScalarFieldEnum) === "function" ? _c : Object)
], WebhookEntities.prototype, "webhookUser", void 0);
...
const common_2 = __webpack_require__(7);
const webhook_client_1 = __webpack_require__(102);
const axios_2 = __webpack_require__(127);
...
exports.WebhookServiceBootstrap = WebhookServiceBootstrap = WebhookServiceBootstrap_1 = tslib_1.__decorate([
    (0, common_2.Injectable)(),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(webhook_constants_1.WEBHOOK_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof webhook_client_1.PrismaClient !== "undefined" && webhook_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof webhook_environments_1.WebhookEnvironments !== "undefined" && webhook_environments_1.WebhookEnvironments) === "function" ? _b : Object, typeof (_c = typeof axios_1.HttpService !== "undefined" && axios_1.HttpService) === "function" ? _c : Object, typeof (_d = typeof webhook_service_1.WebhookService !== "undefined" && webhook_service_1.WebhookService) === "function" ? _d : Object])
...
exports.WebhookService = WebhookService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof webhook_configuration_1.WebhookConfiguration !== "undefined" && webhook_configuration_1.WebhookConfiguration) === "function" ? _a : Object])
], WebhookService);
...
const common_1 = __webpack_require__(7);
const webhook_client_1 = __webpack_require__(102);
const fp_1 = __webpack_require__(131);
const node_crypto_1 = __webpack_require__(95);
const webhook_constants_1 = __webpack_require__(100);
...
exports.WebhookUsersService = WebhookUsersService = tslib_1.__decorate([
    (0, common_1.Injectable)(),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)(webhook_constants_1.WEBHOOK_FEATURE)),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof webhook_client_1.PrismaClient !== "undefined" && webhook_client_1.PrismaClient) === "function" ? _a : Object])
], WebhookUsersService);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], ConnectWebhookLogDto.prototype, "id", void 0);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ConnectWebhookUserDto = exports.WebhookUserExternalTenantIdExternalUserIdUniqueInputDto = void 0;
const tslib_1 = __webpack_require__(1);
const swagger_1 = __webpack_require__(23);
const class_validator_multi_lang_1 = __webpack_require__(15);
const class_transformer_global_storage_1 = __webpack_require__(24);
...
exports.WebhookUserExternalTenantIdExternalUserIdUniqueInputDto = WebhookUserExternalTenantIdExternalUserIdUniqueInputDto;
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], WebhookUserExternalTenantIdExternalUserIdUniqueInputDto.prototype, "externalTenantId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], WebhookUserExternalTenantIdExternalUserIdUniqueInputDto.prototype, "externalUserId", void 0);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], ConnectWebhookUserDto.prototype, "id", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
    ...
    (0, class_validator_multi_lang_1.IsOptional)(),
    (0, class_validator_multi_lang_1.ValidateNested)(),
    (0, class_transformer_global_storage_1.Type)(() => WebhookUserExternalTenantIdExternalUserIdUniqueInputDto),
    tslib_1.__metadata("design:type", WebhookUserExternalTenantIdExternalUserIdUniqueInputDto)
], ConnectWebhookUserDto.prototype, "externalTenantId_externalUserId", void 0);
exports.ConnectWebhookUserDto = ConnectWebhookUserDto = tslib_1.__decorate([
    (0, swagger_1.ApiExtraModels)(WebhookUserExternalTenantIdExternalUserIdUniqueInputDto)
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], ConnectWebhookDto.prototype, "id", void 0);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", typeof (_a = typeof webhook_client_1.Prisma !== "undefined" && webhook_client_1.Prisma.InputJsonValue) === "function" ? _a : Object)
], CreateWebhookLogDto.prototype, "request", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], CreateWebhookLogDto.prototype, "responseStatus", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: () => Object,
        required: false,
    ...
    (0, class_validator_multi_lang_1.IsOptional)(),
    tslib_1.__metadata("design:type", Object)
], CreateWebhookLogDto.prototype, "response", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: webhook_client_1.WebhookStatus,
        enumName: 'WebhookStatus',
    ...
    (0, class_validator_multi_lang_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", typeof (_d = typeof webhook_client_1.WebhookStatus !== "undefined" && webhook_client_1.WebhookStatus) === "function" ? _d : Object)
], CreateWebhookLogDto.prototype, "webhookStatus", void 0);
...
tslib_1.__decorate([
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], CreateWebhookUserDto.prototype, "externalTenantId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    ...
    (0, class_validator_multi_lang_1.IsString)(),
    tslib_1.__metadata("design:type", String)
], CreateWebhookUserDto.prototype, "externalUserId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        enum: webhook_client_1.WebhookRole,
        enumName: 'WebhookRole',
    ...
    (0, class_validator_multi_lang_1.IsNotEmpty)(),
    tslib_1.__metadata("design:type", typeof (_a = typeof webhook_client_1.WebhookRole !== "undefined" && webhook_client_1.WebhookRole) === "function" ? _a : Object)
], CreateWebhookUserDto.prototype, "userRole", void 0);
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", String)
], WebhookDto.prototype, "eventName", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], WebhookDto.prototype, "endpoint", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'boolean',
    }),
    tslib_1.__metadata("design:type", Boolean)
], WebhookDto.prototype, "enabled", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: () => Object,
        nullable: true,
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Object)
], WebhookDto.prototype, "requestTimeout", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], WebhookDto.prototype, "externalTenantId", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Object)
], WebhookDto.prototype, "workUntilDate", void 0);
...
"use strict";
module.exports = require("@nestjs-mod/docker-compose");
...
"use strict";
module.exports = require("@nestjs-mod/pg-flyway");
...
"use strict";
module.exports = require("@nestjs-mod/pm2");
...
"use strict";
module.exports = require("@nestjs-mod/terminus");
...
const common_2 = __webpack_require__(9);
const validation_1 = __webpack_require__(52);
const webhook_1 = __webpack_require__(98);
const prisma_1 = __webpack_require__(28);
const serve_static_1 = __webpack_require__(154);
const nestjs_translates_1 = __webpack_require__(30);
const path_1 = __webpack_require__(49);
const app_controller_1 = __webpack_require__(155);
const app_service_1 = __webpack_require__(157);
const time_controller_1 = __webpack_require__(159);
exports.AppModule = (0, common_1.createNestModule)({
    moduleName: 'AppModule',
    moduleCategory: common_1.NestModuleCategory.feature,
    imports: [
        auth_1.AuthModule.forFeature({
            featureModuleName: 'app',
        }),
        common_2.SupabaseModule.forFeature({
            featureModuleName: 'app',
        }),
        ...
        prisma_1.PrismaModule.forFeature({
            contextName: auth_1.AUTH_FEATURE,
            featureModuleName: 'app',
        }),
        nestjs_translates_1.TranslatesModule.forRootDefault({
            localePaths: [
                (0, path_1.join)(__dirname, 'assets', 'i18n'),
                (0, path_1.join)(__dirname, 'assets', 'i18n', 'getText'),
                (0, path_1.join)(__dirname, 'assets', 'i18n', 'class-validator-multi-lang-messages'),
            ],
            vendorLocalePaths: [(0, path_1.join)(__dirname, 'assets', 'i18n')],
            locales: ['en', 'ru'],
            validationPipeOptions: {
                validatorPackage: __webpack_require__(15),
                transformerPackage: __webpack_require__(24),
                transform: true,
                whitelist: true,
                validationError: {
                    target: false,
                ...
                exceptionFactory: (errors) => new validation_1.ValidationError(validation_1.ValidationErrorEnum.COMMON, undefined, errors),
            },
            usePipes: true,
    ...
    controllers: [app_controller_1.AppController, time_controller_1.TimeController],
    providers: [app_service_1.AppService, time_controller_1.TimeController],
}).AppModule;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AppController = exports.AppData = void 0;
const tslib_1 = __webpack_require__(1);
const common_1 = __webpack_require__(7);
const webhook_1 = __webpack_require__(98);
const prisma_1 = __webpack_require__(28);
const swagger_1 = __webpack_require__(23);
const app_client_1 = __webpack_require__(156);
const crypto_1 = __webpack_require__(128);
const nestjs_translates_1 = __webpack_require__(30);
const app_service_1 = __webpack_require__(157);
const app_demo_entity_1 = __webpack_require__(158);
const common_2 = __webpack_require__(9);
const supabase_js_1 = __webpack_require__(19);
class AppData {
}
...
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({ type: String }),
    tslib_1.__metadata("design:type", String)
], AppData.prototype, "message", void 0);
var AppDemoEventName;
(function (AppDemoEventName) {
    AppDemoEventName["app-demo.create"] = "app-demo.create";
    AppDemoEventName["app-demo.update"] = "app-demo.update";
    AppDemoEventName["app-demo.delete"] = "app-demo.delete";
})(AppDemoEventName || (AppDemoEventName = {}));
let AppController = class AppController {
    constructor(appPrismaClient, appService, webhookService) {
        this.appPrismaClient = appPrismaClient;
    ...
    async demoCreateOne(authorizeUser) {
        return await this.appPrismaClient.appDemo
            .create({
            data: { name: 'demo name' + (0, crypto_1.randomUUID)() },
        })
            .then(async (result) => {
            await this.webhookService.sendEvent(AppDemoEventName['app-demo.create'], result, { ['external-user-id']: authorizeUser.id });
            return result;
        });
    }
    async demoFindOne(id) {
        return await this.appPrismaClient.appDemo.findFirstOrThrow({
            where: { id },
        });
    }
    async demoDeleteOne(authorizeUser, id) {
        return await this.appPrismaClient.appDemo
            .delete({ where: { id } })
            .then(async (result) => {
            await this.webhookService.sendEvent(AppDemoEventName['app-demo.delete'], result, { ['external-user-id']: authorizeUser.id });
            return result;
        });
    }
    async demoUpdateOne(authorizeUser, id) {
        return await this.appPrismaClient.appDemo
            .update({
            data: { name: 'new demo name' + (0, crypto_1.randomUUID)(), updatedAt: new Date() },
            where: { id },
        })
            .then(async (result) => {
            await this.webhookService.sendEvent(AppDemoEventName['app-demo.update'], result, { ['external-user-id']: authorizeUser.id });
            return result;
        });
    }
    async demoFindMany() {
...
tslib_1.__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ type: AppData }),
    tslib_1.__param(0, (0, nestjs_translates_1.InjectTranslateFunction)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_d = typeof nestjs_translates_1.TranslateFunction !== "undefined" && nestjs_translates_1.TranslateFunction) === "function" ? _d : Object]),
    tslib_1.__metadata("design:returntype", void 0)
], AppController.prototype, "getData", null);
tslib_1.__decorate([
    (0, common_1.Post)('/demo'),
    (0, swagger_1.ApiCreatedResponse)({ type: app_demo_entity_1.AppDemo }),
    tslib_1.__param(0, (0, common_2.CurrentSupabaseUser)()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_e = typeof supabase_js_1.User !== "undefined" && supabase_js_1.User) === "function" ? _e : Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "demoCreateOne", null);
tslib_1.__decorate([
    (0, common_1.Get)('/demo/:id'),
    (0, swagger_1.ApiOkResponse)({ type: app_demo_entity_1.AppDemo }),
    tslib_1.__param(0, (0, common_1.Param)('id', new common_1.ParseUUIDPipe())),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "demoFindOne", null);
tslib_1.__decorate([
    (0, common_1.Delete)('/demo/:id'),
    (0, swagger_1.ApiOkResponse)({ type: app_demo_entity_1.AppDemo }),
    tslib_1.__param(0, (0, common_2.CurrentSupabaseUser)()),
    tslib_1.__param(1, (0, common_1.Param)('id', new common_1.ParseUUIDPipe())),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_f = typeof common_2.SupabaseUser !== "undefined" && common_2.SupabaseUser) === "function" ? _f : Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "demoDeleteOne", null);
tslib_1.__decorate([
    (0, common_1.Put)('/demo/:id'),
    (0, swagger_1.ApiOkResponse)({ type: app_demo_entity_1.AppDemo }),
    tslib_1.__param(0, (0, common_2.CurrentSupabaseUser)()),
    tslib_1.__param(1, (0, common_1.Param)('id', new common_1.ParseUUIDPipe())),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_g = typeof supabase_js_1.User !== "undefined" && supabase_js_1.User) === "function" ? _g : Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "demoUpdateOne", null);
tslib_1.__decorate([
    (0, common_1.Get)('/demo'),
    (0, swagger_1.ApiOkResponse)({ type: app_demo_entity_1.AppDemo, isArray: true }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", Promise)
], AppController.prototype, "demoFindMany", null);
exports.AppController = AppController = tslib_1.__decorate([
    (0, common_2.AllowEmptyUser)(),
    (0, common_1.Controller)(),
    tslib_1.__param(0, (0, prisma_1.InjectPrismaClient)('app')),
    tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof app_client_1.PrismaClient !== "undefined" && app_client_1.PrismaClient) === "function" ? _a : Object, typeof (_b = typeof app_service_1.AppService !== "undefined" && app_service_1.AppService) === "function" ? _b : Object, typeof (_c = typeof webhook_1.WebhookService !== "undefined" && webhook_1.WebhookService) === "function" ? _c : Object])
], AppController);
...
"use strict";
module.exports = require("@prisma/app-client");
...
var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AppDemo = void 0;
const tslib_1 = __webpack_require__(1);
const swagger_1 = __webpack_require__(23);
class AppDemo {
}
exports.AppDemo = AppDemo;
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], AppDemo.prototype, "id", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
    }),
    tslib_1.__metadata("design:type", String)
], AppDemo.prototype, "name", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof Date !== "undefined" && Date) === "function" ? _a : Object)
], AppDemo.prototype, "createdAt", void 0);
tslib_1.__decorate([
    (0, swagger_1.ApiProperty)({
        type: 'string',
        format: 'date-time',
    ...
    tslib_1.__metadata("design:type", typeof (_b = typeof Date !== "undefined" && Date) === "function" ? _b : Object)
], AppDemo.prototype, "updatedAt", void 0);
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.TimeController = exports.ChangeTimeStream = void 0;
const tslib_1 = __webpack_require__(1);
const auth_1 = __webpack_require__(3);
const common_1 = __webpack_require__(7);
const swagger_1 = __webpack_require__(23);
const websockets_1 = __webpack_require__(160);
const rxjs_1 = __webpack_require__(36);
exports.ChangeTimeStream = 'ChangeTimeStream';
let TimeController = class TimeController {
    ...
    onChangeTimeStream() {
        return (0, rxjs_1.interval)(1000).pipe((0, rxjs_1.map)(() => ({
            data: new Date(),
            event: exports.ChangeTimeStream,
        })));
    }
};
...
tslib_1.__decorate([
    (0, common_1.Get)('/time'),
    (0, swagger_1.ApiOkResponse)({ type: Date }),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", void 0)
], TimeController.prototype, "time", null);
tslib_1.__decorate([
    (0, websockets_1.SubscribeMessage)(exports.ChangeTimeStream),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", []),
    tslib_1.__metadata("design:returntype", typeof (_a = typeof rxjs_1.Observable !== "undefined" && rxjs_1.Observable) === "function" ? _a : Object)
], TimeController.prototype, "onChangeTimeStream", null);
exports.TimeController = TimeController = tslib_1.__decorate([
    (0, auth_1.UseAuthInterceptorsAndGuards)({ allowEmptyUser: true }),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__(1);
const postgres_1 = tslib_1.__importDefault(__webpack_require__(2));
const auth_1 = __webpack_require__(3);
const common_1 = __webpack_require__(9);
const files_1 = __webpack_require__(88);
const prisma_tools_1 = __webpack_require__(43);
const validation_1 = __webpack_require__(52);
const webhook_1 = __webpack_require__(98);
const common_2 = __webpack_require__(6);
const docker_compose_1 = __webpack_require__(147);
const keyv_1 = __webpack_require__(34);
const minio_1 = __webpack_require__(93);
const pg_flyway_1 = __webpack_require__(148);
const pm2_1 = __webpack_require__(149);
const prisma_1 = __webpack_require__(28);
const terminus_1 = __webpack_require__(150);
const platform_ws_1 = __webpack_require__(151);
const swagger_1 = __webpack_require__(23);
const terminus_2 = __webpack_require__(152);
...
let rootFolder = (0, path_1.join)(__dirname, '..', '..', '..');
if (!(0, fs_1.existsSync)((0, path_1.join)(rootFolder, PACKAGE_JSON_FILE)) &&
    (0, fs_1.existsSync)((0, path_1.join)(__dirname, PACKAGE_JSON_FILE))) {
    rootFolder = (0, path_1.join)(__dirname);
}
let appFolder = (0, path_1.join)(rootFolder, 'apps', 'server');
if (!(0, fs_1.existsSync)((0, path_1.join)(appFolder, PACKAGE_JSON_FILE))) {
    appFolder = (0, path_1.join)(rootFolder, 'dist', 'apps', 'server');
}
if (!(0, fs_1.existsSync)((0, path_1.join)(appFolder, PACKAGE_JSON_FILE)) &&
    (0, fs_1.existsSync)((0, path_1.join)(__dirname, PACKAGE_JSON_FILE))) {
    appFolder = (0, path_1.join)(__dirname);
}
(0, common_2.bootstrapNestApplication)({
    project: {
        name: 'server',
    ...
    modules: {
        system: [
            common_2.ProjectUtils.forRoot({
                staticConfiguration: {
                    applicationPackageJsonFile: (0, path_1.join)(appFolder, PACKAGE_JSON_FILE),
                    packageJsonFile: (0, path_1.join)(rootFolder, PACKAGE_JSON_FILE),
                    nxProjectJsonFile: (0, path_1.join)(appFolder, common_2.PROJECT_JSON_FILE),
                    envFile: (0, path_1.join)(rootFolder, '.env'),
                    printAllApplicationEnvs: true,
                },
            }),
            common_2.DefaultNestApplicationInitializer.forRoot({
                staticConfiguration: { bufferLogs: true },
            }),
            // NestjsPinoLoggerModule.forRoot(),
            terminus_1.TerminusHealthCheckModule.forRootAsync({
                imports: [
                    prisma_1.PrismaModule.forFeature({
                    ...
                    prisma_1.PrismaModule.forFeature({
                        featureModuleName: 'TerminusHealthCheckModule',
                        contextName: webhook_1.WEBHOOK_FEATURE,
                    }),
                ],
                configurationFactory: (memoryHealthIndicator, prismaHealthIndicator, appPrismaClient, authPrismaClient, webhookPrismaClient) => ({
                    standardHealthIndicators: [
                        ...
                        {
                            name: `database_${'app'}`,
                            check: () => prismaHealthIndicator.pingCheck(`database_${'app'}`, appPrismaClient, { timeout: 60 * 1000 }),
                        },
                        {
                            name: `database_${auth_1.AUTH_FEATURE}`,
                            check: () => prismaHealthIndicator.pingCheck(`database_${auth_1.AUTH_FEATURE}`, authPrismaClient, { timeout: 60 * 1000 }),
                        },
                        {
                            name: `database_${webhook_1.WEBHOOK_FEATURE}`,
                            check: () => prismaHealthIndicator.pingCheck(`database_${webhook_1.WEBHOOK_FEATURE}`, webhookPrismaClient, { timeout: 60 * 1000 }),
                        },
                    ],
                }),
                inject: [
                    terminus_2.MemoryHealthIndicator,
                    terminus_2.PrismaHealthIndicator,
                    (0, prisma_1.getPrismaClientToken)('app'),
                    (0, prisma_1.getPrismaClientToken)(auth_1.AUTH_FEATURE),
                    (0, prisma_1.getPrismaClientToken)(webhook_1.WEBHOOK_FEATURE),
                ],
            }),
            common_2.DefaultNestApplicationListener.forRoot({
                staticConfiguration: {
                    // When running in infrastructure mode, the backend server does not start.
                    mode: (0, common_2.isInfrastructureMode)() ? 'silent' : 'listen',
                    async preListen(options) {
                        if (options.app) {
                            options.app.setGlobalPrefix('api');
                            const swaggerConf = new swagger_1.DocumentBuilder().addBearerAuth().build();
                            const document = swagger_1.SwaggerModule.createDocument(options.app, swaggerConf);
                            swagger_1.SwaggerModule.setup('swagger', options.app, document);
                            options.app.useWebSocketAdapter(new platform_ws_1.WsAdapter(options.app));
                            if ((0, common_2.isInfrastructureMode)()) {
                                (0, fs_1.writeFileSync)((0, path_1.join)(rootFolder, 'app-swagger.json'), JSON.stringify(document));
                            }
                        }
                    },
                },
        ...
        core: [
            common_1.SupabaseModule.forRootAsync({
                imports: [
                    webhook_1.WebhookModule.forFeature({ featureModuleName: auth_1.AUTH_FEATURE }),
                    auth_1.AuthModule.forFeature({ featureModuleName: auth_1.AUTH_FEATURE }),
                ],
                inject: [webhook_1.WebhookUsersService, auth_1.AuthEnvironments],
                configurationFactory: (webhookUsersService, authEnvironments) => {
                    return {
                        checkAccessValidator: async (supabaseUser, options, ctx) => {
                            if (typeof ctx?.getClass === 'function' &&
                                typeof ctx?.getHandler === 'function' &&
                                ctx?.getClass().name === 'TerminusHealthCheckController' &&
                                ctx?.getHandler().name === 'check') {
                                return true;
                            }
                            const result = await (0, common_1.defaultSupabaseCheckAccessValidator)(supabaseUser, options);
                            const req = ctx && (0, common_2.getRequestFromExecutionContext)(ctx);
                            if (req?.supabaseUser?.id) {
                                // webhook
                                req.webhookUser =
                                ...
                                if (authEnvironments.adminEmail &&
                                ...
                                // files
                                req.filesUser = {
                                    userRole: req.webhookUser?.userRole === 'Admin'
                                        ? files_1.FilesRole.Admin
                                        : files_1.FilesRole.User,
                                };
                            }
                            return result;
                        },
            ...
            prisma_tools_1.PrismaToolsModule.forRoot(),
            prisma_1.PrismaModule.forRoot({
                contextName: appFeatureName,
                staticConfiguration: {
                    featureName: appFeatureName,
                    schemaFile: (0, path_1.join)(appFolder, 'src', 'prisma', `${appFeatureName}-${prisma_1.PRISMA_SCHEMA_FILE}`),
                    prismaModule: (0, common_2.isInfrastructureMode)()
                        ? Promise.resolve().then(() => tslib_1.__importStar(__webpack_require__(28))) : Promise.resolve().then(() => tslib_1.__importStar(__webpack_require__(156))),
            ...
            prisma_1.PrismaModule.forRoot({
                contextName: webhook_1.WEBHOOK_FEATURE,
                staticConfiguration: {
                    featureName: webhook_1.WEBHOOK_FEATURE,
                    schemaFile: (0, path_1.join)(rootFolder, webhook_1.WEBHOOK_FOLDER, 'src', 'prisma', prisma_1.PRISMA_SCHEMA_FILE),
                    prismaModule: (0, common_2.isInfrastructureMode)()
                        ? Promise.resolve().then(() => tslib_1.__importStar(__webpack_require__(28))) : Promise.resolve().then(() => tslib_1.__importStar(__webpack_require__(102))),
                    addMigrationScripts: false,
                    nxProjectJsonFile: (0, path_1.join)(rootFolder, webhook_1.WEBHOOK_FOLDER, common_2.PROJECT_JSON_FILE),
                    binaryTargets: [],
                },
            }),
            prisma_1.PrismaModule.forRoot({
                contextName: auth_1.AUTH_FEATURE,
                staticConfiguration: {
                    featureName: auth_1.AUTH_FEATURE,
                    schemaFile: (0, path_1.join)(rootFolder, auth_1.AUTH_FOLDER, 'src', 'prisma', prisma_1.PRISMA_SCHEMA_FILE),
                    prismaModule: (0, common_2.isInfrastructureMode)()
                        ? Promise.resolve().then(() => tslib_1.__importStar(__webpack_require__(28))) : Promise.resolve().then(() => tslib_1.__importStar(__webpack_require__(29))),
                    addMigrationScripts: false,
                    nxProjectJsonFile: (0, path_1.join)(rootFolder, auth_1.AUTH_FOLDER, common_2.PROJECT_JSON_FILE),
                    binaryTargets: [],
                },
            }),
            keyv_1.KeyvModule.forRoot({
                staticConfiguration: {
                    storeFactoryByEnvironmentUrl: (uri) => {
                        return (0, common_2.isInfrastructureMode)()
                            ? undefined
                            : [new postgres_1.default({ uri }), { table: 'cache' }];
                    },
                },
            }),
            minio_1.MinioModule.forRoot({
                staticConfiguration: { region: 'eu-central-1' },
                staticEnvironments: {
                    minioUseSSL: 'true',
                },
            }),
            files_1.FilesModule.forRoot(),
            validation_1.ValidationModule.forRoot({ staticEnvironments: { usePipes: false } }),
        ],
        feature: [
            app_module_1.AppModule.forRoot(),
            auth_1.AuthModule.forRootAsync({}),
            webhook_1.WebhookModule.forRootAsync({
                staticEnvironments: { checkHeaders: false },
                configuration: {
                    events: [
                        {
                            eventName: 'app-demo.create',
                            description: (0, nestjs_translates_1.getText)('Event that will be triggered after creation'),
                            example: {
                        ...
                        },
                        {
                            ...
                            description: (0, nestjs_translates_1.getText)('Event that will trigger after the update'),
                            example: {
                                id: 'e4be9194-8c41-4058-bf70-f52a30bccbeb',
                                name: 'demo name',
                                createdAt: '2024-10-02T18:49:07.992Z',
                        ...
                        },
                        {
                            ...
                            description: (0, nestjs_translates_1.getText)('Event that will fire after deletion'),
                            example: {
                                id: 'e4be9194-8c41-4058-bf70-f52a30bccbeb',
                                name: 'demo name',
                                createdAt: '2024-10-02T18:49:07.992Z',
        ...
        infrastructure: [
            common_2.InfrastructureMarkdownReportGenerator.forRoot({
                staticConfiguration: {
                    markdownFile: (0, path_1.join)(appFolder, 'INFRASTRUCTURE.MD'),
            ...
            pm2_1.Pm2.forRoot({
                configuration: {
                    ecosystemConfigFile: (0, path_1.join)(rootFolder, pm2_1.ECOSYSTEM_CONFIG_FILE),
                    applicationScriptFile: (0, path_1.join)('dist/apps/server/main.js'),
                },
            }),
            docker_compose_1.DockerCompose.forRoot({
                configuration: {
                    dockerComposeFileVersion: '3',
                    dockerComposeFile: (0, path_1.join)(appFolder, docker_compose_1.DOCKER_COMPOSE_FILE),
                },
            }),
            docker_compose_1.DockerComposePostgreSQL.forRoot(),
            docker_compose_1.DockerComposePostgreSQL.forFeature({
                featureModuleName: appFeatureName,
            }),
            docker_compose_1.DockerComposeRedis.forRoot({
                staticConfiguration: { image: 'bitnami/redis:7.4.1' },
            }),
            docker_compose_1.DockerComposeMinio.forRoot({
                staticConfiguration: { image: 'bitnami/minio:2024.11.7' },
            }),
            pg_flyway_1.PgFlyway.forRoot({
                staticConfiguration: {
                    featureName: appFeatureName,
                    migrationsFolder: (0, path_1.join)(appFolder, 'src', 'migrations'),
                },
            }),
            docker_compose_1.DockerComposePostgreSQL.forFeatureAsync({
                featureModuleName: webhook_1.WEBHOOK_FEATURE,
            ...
            pg_flyway_1.PgFlyway.forRoot({
                staticConfiguration: {
                    featureName: webhook_1.WEBHOOK_FEATURE,
                    migrationsFolder: (0, path_1.join)(rootFolder, webhook_1.WEBHOOK_FOLDER, 'src', 'migrations'),
                    nxProjectJsonFile: (0, path_1.join)(rootFolder, webhook_1.WEBHOOK_FOLDER, common_2.PROJECT_JSON_FILE),
                },
            }),
            docker_compose_1.DockerComposePostgreSQL.forFeatureAsync({
                featureModuleName: auth_1.AUTH_FEATURE,
                featureConfiguration: {
                    nxProjectJsonFile: (0, path_1.join)(rootFolder, auth_1.AUTH_FOLDER, common_2.PROJECT_JSON_FILE),
                },
            }),
            pg_flyway_1.PgFlyway.forRoot({
                staticConfiguration: {
                    featureName: auth_1.AUTH_FEATURE,
                    migrationsFolder: (0, path_1.join)(rootFolder, auth_1.AUTH_FOLDER, 'src', 'migrations'),
                    nxProjectJsonFile: (0, path_1.join)(rootFolder, auth_1.AUTH_FOLDER, common_2.PROJECT_JSON_FILE),
                },
            }),
        ],
