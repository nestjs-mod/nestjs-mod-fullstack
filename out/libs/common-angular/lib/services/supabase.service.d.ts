...
export declare function mapAuthResponse(): import("rxjs").OperatorFunction<AuthResponse, {
...
export declare function mapUserResponse(): import("rxjs").OperatorFunction<UserResponse, {
    user: import("@supabase/supabase-js").AuthUser;
} | {
    user: null;
}>;
export declare function mapAuthTokenResponsePassword(): import("rxjs").OperatorFunction<AuthTokenResponsePassword, {
    user: import("@supabase/supabase-js").AuthUser;
