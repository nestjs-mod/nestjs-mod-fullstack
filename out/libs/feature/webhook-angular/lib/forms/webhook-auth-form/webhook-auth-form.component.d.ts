...
export declare class WebhookAuthFormComponent implements OnInit {
    ...
    constructor(nzModalData: WebhookAuthFormComponent, webhookConfiguration: WebhookConfiguration, webhookAuthService: WebhookAuthService, nzMessageService: NzMessageService, translocoService: TranslocoService, webhookAuthFormService: WebhookAuthFormService, webhookAuthMapperService: WebhookAuthMapperService);
    ngOnInit(): void;
    setFieldsAndModel(data?: Partial<WebhookAuthCredentials>, settings?: {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<WebhookAuthFormComponent, [{ optional: true; }, null, null, null, null, null, null]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<WebhookAuthFormComponent, "webhook-auth-form", never, { "hideButtons": { "alias": "hideButtons"; "required": false; }; }, { "afterSignIn": "afterSignIn"; }, never, never, true, never>;
}
