...
let WebhookServiceBootstrap =
  (WebhookServiceBootstrap_1 = class WebhookServiceBootstrap {
    constructor(
      prismaClient,
      webhookEnvironments,
      httpService,
    ...
    subscribeToEvents() {
      ...
      this.eventsRef = this.webhookService.events$
        ...
        .pipe(
          (0, rxjs_1.concatMap)(
            async ({ eventName, eventBody, eventHeaders }) => {
                    ...
                    try {
                      await this.prismaClient.webhookLog.update({
                        ...
                        data: {
                          ...
                          response,
                          webhookStatus:
                            err instanceof rxjs_1.TimeoutError
                              ? 'Timeout'
                              : 'Error',
                          updatedAt: new Date(),
                        },
...
exports.WebhookServiceBootstrap =
  WebhookServiceBootstrap =
  WebhookServiceBootstrap_1 =
    tslib_1.__decorate(
      [
