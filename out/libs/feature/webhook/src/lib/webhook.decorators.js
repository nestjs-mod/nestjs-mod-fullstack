...
exports.CurrentWebhookExternalTenantId =
  exports.CurrentWebhookUser =
  exports.CurrentWebhookRequest =
  exports.CheckWebhookRole =
  exports.SkipWebhookGuard =
    void 0;
...
exports.CurrentWebhookRequest = (0, common_2.createParamDecorator)(
  (_data, ctx) => {
    const req = (0, common_1.getRequestFromExecutionContext)(ctx);
    return req;
  }
);
exports.CurrentWebhookUser = (0, common_2.createParamDecorator)(
  (_data, ctx) => {
    const req = (0, common_1.getRequestFromExecutionContext)(ctx);
    return req.webhookUser;
  }
);
exports.CurrentWebhookExternalTenantId = (0, common_2.createParamDecorator)(
  (_data, ctx) => {
    const req = (0, common_1.getRequestFromExecutionContext)(ctx);
    if (
