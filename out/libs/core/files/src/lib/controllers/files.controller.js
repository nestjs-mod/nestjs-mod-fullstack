...
exports.FilesController =
  exports.DeleteFileArgs =
  exports.PresignedUrls =
  exports.GetPresignedUrlArgs =
    void 0;
...
let FilesController = class FilesController {
  ...
  async deleteFile(deleteFileArgs, filesRequest, getText) {
    if (
      filesRequest.filesUser?.userRole === files_role_1.FilesRole.Admin ||
