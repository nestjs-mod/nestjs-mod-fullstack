...
export declare class AuthSignInFormComponent implements OnInit {
    ...
    constructor(nzModalData: AuthSignInFormComponent, authService: AuthService, nzMessageService: NzMessageService, translocoService: TranslocoService, authSignInFormService: AuthSignInFormService, authSignInMapperService: AuthSignInMapperService, validationService: ValidationService);
    ngOnInit(): void;
    setFieldsAndModel(data?: LoginInput): void;
    submitForm(): void;
    private setFormlyFields;
    static ɵfac: i0.ɵɵFactoryDeclaration<AuthSignInFormComponent, [{ optional: true; }, null, null, null, null, null, null]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<AuthSignInFormComponent, "auth-sign-in-form", never, { "hideButtons": { "alias": "hideButtons"; "required": false; }; }, { "afterSignIn": "afterSignIn"; }, never, never, true, never>;
}
