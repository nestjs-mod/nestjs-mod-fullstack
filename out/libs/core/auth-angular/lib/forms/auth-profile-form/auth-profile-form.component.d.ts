...
export declare class AuthProfileFormComponent implements OnInit {
    ...
    constructor(nzModalData: AuthProfileFormComponent, authService: AuthService, nzMessageService: NzMessageService, translocoService: TranslocoService, authProfileFormService: AuthProfileFormService, authProfileMapperService: AuthProfileMapperService, validationService: ValidationService);
    ngOnInit(): void;
    setFieldsAndModel(data?: UpdateProfileInput): void;
    private setFormlyFields;
    submitForm(): void;
    private fillFromProfile;
    static ɵfac: i0.ɵɵFactoryDeclaration<AuthProfileFormComponent, [{ optional: true; }, null, null, null, null, null, null]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<AuthProfileFormComponent, "auth-profile-form", never, { "hideButtons": { "alias": "hideButtons"; "required": false; }; }, {}, never, never, true, never>;
}
