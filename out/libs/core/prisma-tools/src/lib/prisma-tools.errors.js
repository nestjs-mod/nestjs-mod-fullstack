...
exports.DATABASE_ERROR_ENUM_TITLES = {
  [DatabaseErrorEnum.COMMON]: (0, nestjs_translates_1.getText)(
    'Common db error'
  ),
  [DatabaseErrorEnum.UNHANDLED_ERROR]: (0, nestjs_translates_1.getText)(
    'Unhandled error'
  ),
  [DatabaseErrorEnum.UNIQUE_ERROR]: (0, nestjs_translates_1.getText)(
    'Unique error'
  ),
  [DatabaseErrorEnum.INVALID_IDENTIFIER]: (0, nestjs_translates_1.getText)(
    'Invalid identifier'
  ),
  [DatabaseErrorEnum.INVALID_LINKED_TABLE_IDENTIFIER]: (0,
  nestjs_translates_1.getText)('Invalid linked table identifier'),
  [DatabaseErrorEnum.DATABASE_QUERY_ERROR]: (0, nestjs_translates_1.getText)(
    'Database query error'
  ),
  [DatabaseErrorEnum.NOT_FOUND_ERROR]: (0, nestjs_translates_1.getText)(
    'Not found error'
  ),
};
class DatabaseError extends Error {
  constructor(message, code, metadata) {
    const messageAsCode = Boolean(
      message && Object.values(DatabaseErrorEnum).includes(message)
    );
