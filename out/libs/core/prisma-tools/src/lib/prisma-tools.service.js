    ...
    try {
      ...
      if (
        ...
        if (exception?.code === 'P2002') {
          return {
            message:
              prisma_tools_errors_1.DATABASE_ERROR_ENUM_TITLES[
                prisma_tools_errors_1.DatabaseErrorEnum.UNIQUE_ERROR
              ],
            stacktrace,
        ...
        if (exception?.code === 'P2025') {
          if (exception.meta?.['cause'] === 'Record to update not found.') {
            return {
              message:
                prisma_tools_errors_1.DATABASE_ERROR_ENUM_TITLES[
                  prisma_tools_errors_1.DatabaseErrorEnum.INVALID_IDENTIFIER
                ],
              stacktrace,
          ...
          return {
            message:
              prisma_tools_errors_1.DATABASE_ERROR_ENUM_TITLES[
                prisma_tools_errors_1.DatabaseErrorEnum
                  .INVALID_LINKED_TABLE_IDENTIFIER
              ],
            stacktrace,
            code: prisma_tools_errors_1.DatabaseErrorEnum
              .INVALID_LINKED_TABLE_IDENTIFIER,
            metadata: exception?.meta,
            originalError,
          };
        ...
        return {
          message:
            prisma_tools_errors_1.DATABASE_ERROR_ENUM_TITLES[
              prisma_tools_errors_1.DatabaseErrorEnum.DATABASE_QUERY_ERROR
            ],
          stacktrace,
      ...
      return {
        message:
          prisma_tools_errors_1.DATABASE_ERROR_ENUM_TITLES[
            prisma_tools_errors_1.DatabaseErrorEnum.UNHANDLED_ERROR
          ],
...
exports.PrismaToolsService =
  PrismaToolsService =
  PrismaToolsService_1 =
    tslib_1.__decorate(
      [
