...
const config = {
  ...
  "inlineSchemaHash": "f19b3ddfbf6c921d700c4b3e1f2706b830a3f2496b1e5ca5ab9640c5f2209207",
  "copyEngine": true
}
...
const config = {
  ...
  "inlineSchemaHash": "06e742013267ab9020ff45fd25af2537dfcc6fad9caaae777aa4bd2ab3cdc507",
  "copyEngine": true
}
...
const rootFolder = (0, path_1.join)(__dirname, '..', '..', '..');
let appFolder = (0, path_1.join)(rootFolder, 'apps', 'server');
if (!(0, fs_1.existsSync)((0, path_1.join)(appFolder, common_2.PACKAGE_JSON_FILE))) {
    ...
    modules: {
        system: [
            common_2.ProjectUtils.forRoot({
                staticConfiguration: {
                    applicationPackageJsonFile: (0, path_1.join)(appFolder, common_2.PACKAGE_JSON_FILE),
                    packageJsonFile: (0, path_1.join)(rootFolder, common_2.PACKAGE_JSON_FILE),
