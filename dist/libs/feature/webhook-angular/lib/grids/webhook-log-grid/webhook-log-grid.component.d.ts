...
import { WebhookLogInterface, WebhookLogScalarFieldEnumInterface } from '@nestjs-mod-fullstack/app-angular-rest-sdk';
...
export declare class WebhookLogGridComponent implements OnInit, OnChanges {
    ...
    columns: {
        [x: string]: "webhook-log.grid.columns.id" | "webhook-log.grid.columns.request" | "webhook-log.grid.columns.response" | "webhook-log.grid.columns.response-status" | "webhook-log.grid.columns.webhook-status";
    };
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<WebhookLogGridComponent, "webhook-log-grid", never, { "webhookId": { "alias": "webhookId"; "required": true; }; }, {}, never, never, true, never>;
}
