...
export declare class WebhookLogService {
    ...
    constructor(webhookAuthService: WebhookAuthService, webhookRestService: WebhookRestService);
    findMany({ filters, meta, }: {
        filters: Record<string, string>;
        meta?: RequestMeta;
    }): import("rxjs").Observable<import("@nestjs-mod-fullstack/app-angular-rest-sdk").FindManyWebhookLogResponseInterface>;
