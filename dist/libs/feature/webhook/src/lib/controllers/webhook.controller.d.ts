...
export declare class WebhookController {
    ...
    constructor(prismaClient: PrismaClient, webhookConfiguration: WebhookConfiguration, prismaToolsService: PrismaToolsService, webhookToolsService: WebhookToolsService, translatesService: TranslatesService);
    ...
    findMany(externalTenantId: string, webhookUser: WebhookUser, args: FindManyArgs): Promise<{
        webhooks: {
            eventName: string;
            id: string;
    ...
    createOne(externalTenantId: string, webhookUser: WebhookUser, args: CreateWebhookDto): Promise<{
        eventName: string;
        id: string;
        externalTenantId: string;
        createdAt: Date;
    ...
    updateOne(externalTenantId: string, webhookUser: WebhookUser, id: string, args: UpdateWebhookDto): Promise<{
        eventName: string;
        id: string;
        externalTenantId: string;
        createdAt: Date;
    ...
    findManyLogs(externalTenantId: string, webhookUser: WebhookUser, id: string, args: FindManyArgs): Promise<{
        webhookLogs: {
            id: string;
