...
export declare class WebhookUsersController {
    ...
    constructor(prismaClient: PrismaClient, prismaToolsService: PrismaToolsService, webhookToolsService: WebhookToolsService, webhookCacheService: WebhookCacheService);
    ...
    updateOne(externalTenantId: string, webhookUser: WebhookUser, id: string, args: UpdateWebhookUserDto): Promise<{
        id: string;
        externalTenantId: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    deleteOne(externalTenantId: string, webhookUser: WebhookUser, id: string, getText: TranslateFunction): Promise<{
        message: string;
    }>;
