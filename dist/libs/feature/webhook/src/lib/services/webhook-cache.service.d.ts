...
export declare class WebhookCacheService {
    ...
    constructor(prismaClient: PrismaClient, webhookConfiguration: WebhookConfiguration, keyvService: KeyvService);
    clearCacheByExternalUserId(externalUserId: string): Promise<void>;
    getCachedUserByExternalUserId(externalUserId: string, externalTenantId?: string): Promise<{
        id: string;
