...
export declare class FilesService {
    ...
    getPresignedUrl(file: File): Observable<import("@nestjs-mod-fullstack/app-angular-rest-sdk").PresignedUrlsInterface>;
    uploadFile({ file, presignedUrls, }: {
        file: File;
        presignedUrls: PresignedUrls;
    }): Observable<PresignedUrls>;
    deleteFile(downloadUrl: string): Observable<import("@nestjs-mod-fullstack/app-angular-rest-sdk").StatusResponseInterface>;
