...
export declare class AuthGuard implements CanActivate {
    ...
    private logger;
    constructor(prismaClient: PrismaClient, reflector: Reflector, authCacheService: AuthCacheService, authEnvironments: AuthEnvironments, translatesStorage: TranslatesStorage);
